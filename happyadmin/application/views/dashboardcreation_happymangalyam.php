...
<?php include('menucreation_happymangalyam.php'); ?>
...
<div class="app-wrapper">
	...
	<div class="app-content pt-3 p-md-3 p-lg-4">
		<div class="container-xl">
			...
			<h3 class="mb-3">Happymangalyam Nikah Creation Dashboard!</h3>
			<div class="row gx-5 gy-3">
			<div class="col-12 col-lg-8">

			<div style="font-family: Bradley Hand, cursive;">
			Happymangalyam.com Meet your perfect partner from sites to "tie up together",<br>
			All Muslim community can find their suitable brides and grooms with thousands of profiles.
		    </div>
			</div>
...
<!--								<a href="#">More info <i class="fas fa-arrow-circle-right"></i></a>-->
				...
				<div class="col-6 col-lg-3">
					<div class="app-card app-card-stat shadow-sm h-100" style="border-left: 3px solid orange">
						<div class="app-card-body p-3 p-lg-4">
							<h4 class="stats-type mb-1">Total Creation</h4>
							<div class="stats-figure">
				...
				<div class="col-6 col-lg-3">
					<div class="app-card app-card-stat shadow-sm h-100" style="border-left: 3px solid #15a362;">
						<div class="app-card-body p-3 p-lg-4">
							<h4 class="stats-type mb-1">Short Fall</h4>
							<div class="stats-figure">
								<h3>0</h3>
							</div>
				...
				<div class="col-6 col-lg-3">
					<div class="app-card app-card-stat shadow-sm h-100" style="border-left: 3px solid black">
						<div class="app-card-body p-3 p-lg-4">
							<h4 class="stats-type mb-1">Acheivement</h4>
							<div class="stats-figure">
								<h3>0</h3>
							</div>
							<div class="stats-meta">
				...
				<div class="col-6 col-lg-3">
					<div class="app-card app-card-stat shadow-sm h-100" style="border-left: 3px solid red;">
						<div class="app-card-body p-3 p-lg-4">
							<h4 class="stats-type mb-1">Today's Short Fall</h4><br>
							<div class="stats-figure">
								<h3>0</h3>
							</div>
				...
				<div class="col-6 col-lg-3">
					<div class="app-card app-card-stat shadow-sm h-10" style="border-left: 3px solid #fc6f90">
						<div class="app-card-body p-3 p-lg-4">
							<h4 class="stats-type mb-1">Total Target</h4>
				...
				<div class="col-6 col-lg-3">
					<div class="app-card app-card-stat shadow-sm h-10" style="border-left: 3px solid #15a362;">
						<div class="app-card-body p-3 p-lg-4">
							<h4 class="stats-type mb-1">Total Short Fall</h4>
							<div class="stats-figure">
								<h3>0</h3>
							</div>
							<div class="stats-meta">
				...
				<div class="col-6 col-lg-3">
					<div class="app-card app-card-stat shadow-sm h-10" style="border-left: 3px solid black">
						<div class="app-card-body p-3 p-lg-4">
							<h4 class="stats-type mb-1">Total Acheivement</h4>
							<div class="stats-figure">
								<h3>0</h3>
							</div>
							<div class="stats-meta">
				...
				<!--//col-->
				<div class="col-6 col-lg-3">
					<div class="app-card app-card-stat shadow-sm h-10" style="border-left: 3px solid red">
						<div class="app-card-body p-3 p-lg-4">
							<h4 class="stats-type mb-1">Total Days Left</h4><br>
							<div class="stats-figure">
								<h3>0</h3>
							</div>
							<div class="stats-meta" style="padding-top: 138px;">
