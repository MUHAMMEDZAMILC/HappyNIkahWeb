...
<script>
  ...
  $(document).ready(function() {
    $('#filterForm').submit(function(e) {
      ...
      $.ajax({
        url: '<?php echo base_url('admin/get_malecount_mangalyam'); ?>',
        method: 'post',
        data: formData,
        dataType: 'html',
 ...
 $('#exportto_malemangalyam').click(function() {
  districts = $('#districts').val();
    $.ajax({
        type: 'POST',
        url: '<?= base_url() ?>admin/exportToExcel_malemangalyam', // Check this URL path
        data: {
           districts:districts
        },
        ...
        var downloadUrl = '<?= base_url() ?>upload/male_list_mangalyam.xlsx?cb=' + cacheBuster;
