                            ...
                            <div class="col-12">
                                ...
                                <div class="card">
                                   ...
                                   <?php $sessid=$this->session->userdata('user_id_admin');?>  
                                        <?php $date=date('Y-m-d');?>  
                                 <?php $count_login=$this->db->select('tr.id as trid,tr.happynikah_id,tr.reg_through,tr.name,tr.age,tr.gender,tr.status,tu.*')
                                        ->from('tbl_userlogin as tu')->join('tbl_registration as tr','tr.id=tu.user_id')
                                         ->where('date',$date)->where('tu.is_online','1')->where('tu.emp_id',$sessid)->get()->num_rows();?>
                               ...
                               <?php $date=date('Y-m-d');?>         
                          <?php $data_login=$this->db->select('tr.id as trid,tr.happynikah_id,tr.reg_through,tr.reg_date,tr.name,tr.age,tr.gender,tr.status,tu.*')
