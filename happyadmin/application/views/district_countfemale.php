...
<div class="app-wrapper">
  ...
  <?php include('footer.php'); ?>
   ...
   <script>
    ...
    $.ajax({
    url: '<?php echo base_url('admin/get_femalecount'); ?>',
    method: 'post',
    data: formData,
    dataType: 'html',
    ...
    $.ajax({
    type: 'POST',
    url: '<?= base_url() ?>admin/exportToExcel', // Check this URL path
    data: {
    districts:districts
    },
    ...
    var downloadUrl = '<?= base_url() ?>upload/female_list.xlsx?cb=' + cacheBuster;
