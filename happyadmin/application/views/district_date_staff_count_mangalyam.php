...
<?php  
	...
	->where('reg_date >=',$from_date)->where('reg_date <=',$to_date)->where('staff_id',$user_id)->where('hmangalyam',1)
	->get()->num_rows();
	...
	->where('staff_id',$user_id)->where('gender','1')->where('hmangalyam',1)->get()->num_rows();
	$total_count1_female= $this->db->select('*')->from('tbl_registration')
	->where('home_district',1)->where('reg_date >=',$from_date)->where('reg_date <=',$to_date)
	->where('staff_id',$user_id)->where('gender','2')->where('hmangalyam',1)->get()->num_rows();
	...
	->where('staff_id',$user_id)->where('hmangalyam',1)->where('gender','1')->get()->num_rows();
	$total_count2_female= $this->db->select('*')->from('tbl_registration')
	->where('home_district',2)->where('reg_date >=',$from_date)->where('reg_date <=',$to_date)
	->where('staff_id',$user_id)->where('hmangalyam',1)->where('gender','2')->get()->num_rows();
 

	$total_count3= $this->db->select('*')->from('tbl_registration')->where('home_district',3)
	->where('reg_date >=',$from_date)->where('reg_date <=',$to_date)
	->where('hmangalyam',1)->where('staff_id',$user_id)->get()->num_rows(); 
	...
	->where('reg_date >=',$from_date)->where('reg_date <=',$to_date)->where('staff_id',$user_id)->where('hmangalyam',1)->get()->num_rows(); 
	...
	->where('hmangalyam',1)->get()->num_rows();
	...
	->where('reg_date >=',$from_date)->where('reg_date <=',$to_date)
	->where('staff_id',$user_id)->where('hmangalyam',1)->get()->num_rows(); 
	...
	->where('reg_date >=',$from_date)->where('reg_date <=',$to_date)->where('hmangalyam',1)->where('staff_id',$user_id)
	->get()->num_rows();
