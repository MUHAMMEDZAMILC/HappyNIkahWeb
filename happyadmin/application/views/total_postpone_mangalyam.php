...
<div class="app-wrapper">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                            ...
                            <div class="app-card-body">
                              ...
                              <br/>     
                              <br/> 
                  <form action="<?php echo base_url('admin/total_postponeall_mangalyam'); ?>" method="post" style="margin-bottom: -29px;margin-left: 140px;">  
  ...
  <!-- Page specific script -->
    ...
    dataType: 'text',
    type: 'POST',
    url: url + 'admin/total_postponeall_mangalyam',
    data: {
    emp_id: emp_id    
    },
