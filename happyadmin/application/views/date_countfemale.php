...
<div class="app-wrapper">
  <div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container">
      ...
      <div class="tab-content" id="orders-table-tab-content">
              ...
              <button type="button" class="btn btn-success" id="exportto" style="display: none;">Export to Excel</button>
                     </div>   </div>
  ...
  <?php include('footer.php'); ?>
    ...
    $.ajax({
    url: '<?php echo base_url('admin/get_date_female'); ?>',
    method: 'post',
    data: formData,
    dataType: 'html',
    ...
    $.ajax({
    type: 'POST',
    url: '<?= base_url() ?>admin/exportToExcel_date', // Check this URL path
    data: {
    from_date:from_date,
    to_date:to_date
    },
    ...
    var downloadUrl = '<?= base_url() ?>upload/female_list_date.xlsx?cb=' + cacheBuster;
