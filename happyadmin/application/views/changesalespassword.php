...
svg.svg-inline--fa.fa-xmark {
    ...
    <div class="app-content pt-3 p-md-3 p-lg-4">
        ...
        <?php
        $targetdata2=$this->db->select('*')->from('tbl_employees1')->where('status','1')->get()->result_array();?>
        
        <select class="form-control" id="user_id" name="user_id" required  style="padding-bottom: 4px;margin-left: 1px;margin-top: 20px;width: 65%;">
        ...
        <input type="text" name="pass_sales" class="form-control" id="pass_sales" style="width: 355px;">
        </div>
        ...
        <div class="mb-3">
        <label for="inputName" class="form-label" style="color: black;"><b style="font-weight: 500;">Password</b></label>
        <input type="text" name="pass_chat" class="form-control" id="pass_chat" style="width: 355px;">
        </div>
