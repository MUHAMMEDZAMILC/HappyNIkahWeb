  ...
  <div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container">
      ...
      <div class="tab-content" id="orders-table-tab-content">
                    ...
                    <div class="tab-pane fade show active" id="orders-all" role="tabpanel" aria-labelledby="orders-all-tab">
                        <div class="app-card app-card-orders-table shadow-sm mb-5">
                            ...
                            <div class="app-card-body" style="padding-bottom: 40px;">
                              ...
                              <label style="margin-left: 3px;margin-bottom: 10px;">Female  List:</label><br> 
              ...
              <button type="button" class="btn btn-success" id="exportto_femalemangalyam" style="display: none;">Export to Excel</button>
                     </div>   </div>
...
<script>
  ...
  $(document).ready(function() {
    $('#filterForm').submit(function(e) {
      ...
      $.ajax({
        url: '<?php echo base_url('admin/get_date_female_mangalyam'); ?>',
        method: 'post',
        data: formData,
        dataType: 'html',
        success: function(data) {
          $('#customerData').html(data);
          $("#exportto_femalemangalyam").show();
        }
      });
    });

 $('#exportto_femalemangalyam').click(function() {
  from_date = $('#from_date').val();
  to_date = $('#to_date').val();
    $.ajax({
        type: 'POST',
        url: '<?= base_url() ?>admin/exportToExcel_datemangalyam', // Check this URL path
        data: {
           from_date:from_date,
           to_date:to_date
        },
        success: function(response) 
        {
            ...
            var downloadUrl = '<?= base_url() ?>upload/female_list_datemangalyam.xlsx?cb=' + cacheBuster;
