...
<div class="app-wrapper">
	...
	<div class="app-content pt-3 p-md-3 p-lg-4">
        ...
        <h3 class="mb-3">Happymangalyam Support Admin Dashboard!</h3>
        <div class="row gx-5 gy-3">
        <div class="col-12 col-lg-8">
        
        <div>Happymangalyam.com Meet your perfect partner from sites to "tie up together",<br>
        ...
        <!--//inner-->
               ...
               {?>
                ...
                <?php $photounavail = $this->db->query("SELECT COUNT(*) AS total_count FROM tbl_registration R WHERE NOT EXISTS (SELECT * FROM tbl_userimages U WHERE R.id = U.user_id) AND R.status = '1' AND R.hmangalyam = '1' AND R.photo = ''");?>
                ...
                <?php $photo_unavailbale_male = $this->db->query("SELECT COUNT(*) AS total_count FROM tbl_registration R WHERE NOT EXISTS (SELECT * FROM tbl_userimages U WHERE R.id = U.user_id) AND R.status = '1' AND R.hmangalyam = '1'  AND R.gender='1' AND R.photo = ''");?>
                <?php $photounavailmale_count = $photo_unavailbale_male->row()->total_count;?>
                
                <?php $photo_unavailbale_female = $this->db->query("SELECT COUNT(*) AS total_count FROM tbl_registration R WHERE NOT EXISTS (SELECT * FROM tbl_userimages U WHERE R.id = U.user_id) AND R.status = '1'  AND R.hmangalyam = '1'  AND R.gender='2' AND R.photo = ''");?>
        ...
        <?php $photoavail = $this->db->query("SELECT COUNT(*) AS total_count FROM tbl_registration R WHERE  EXISTS (SELECT * FROM tbl_userimages U WHERE R.id = U.user_id) AND R.status = '1'  AND R.hmangalyam = '1'  AND R.photo!= ''");?>
        <?php $photoavail_count = $photoavail->row()->total_count;?>
        
        <?php $photo_availbale_male = $this->db->query("SELECT COUNT(*) AS total_count FROM tbl_registration R WHERE EXISTS (SELECT * FROM tbl_userimages U WHERE R.id = U.user_id) AND R.status = '1' AND R.hmangalyam = '1'  AND R.gender='1' AND R.photo!= ''");?>
        <?php $photoavailmale_count = $photo_availbale_male->row()->total_count;?>
        
        <?php $photo_availbale_female = $this->db->query("SELECT COUNT(*) AS total_count FROM tbl_registration R WHERE EXISTS (SELECT * FROM tbl_userimages U WHERE R.id = U.user_id) AND R.status = '1'  AND R.hmangalyam = '1'  AND R.gender='2' AND R.photo!= ''");?>
        <?php $photoavailfemale_count = $photo_availbale_female->row()->total_count;?>
        
        
        <?php $daily_reg_date=date('Y-m-d');?>
        <?php $daily_photo = $this->db->select('*')->from('tbl_registration')->where('photo!=','')->where('status','1')->where('hmangalyam','1')->where('reg_date',$daily_reg_date)->get()->num_rows();?>
        <?php $daily_photo_male = $this->db->select('*')->from('tbl_registration')->where('photo!=','')->where('status','1')->where('hmangalyam','1')->where('reg_date',$daily_reg_date)->where('gender','1')->get()->num_rows();?>
        <?php $daily_photo_female = $this->db->select('*')->from('tbl_registration')->where('photo!=','')->where('status','1')->where('hmangalyam','1')->where('reg_date',$daily_reg_date)->where('gender','2')->get()->num_rows();?>
        
        
        <?php $daily_photo_unavailable = $this->db->select('*')->from('tbl_registration')->where('photo','')->where('status','1')->where('hmangalyam','1')->where('reg_date',$daily_reg_date)->get()->num_rows();?>
        <?php $daily_photo_unavailable_male = $this->db->select('*')->from('tbl_registration')->where('photo','')->where('status','1')->where('hmangalyam','1')->where('gender','1')->where('reg_date',$daily_reg_date)->get()->num_rows();?>
        <?php $daily_photo_unavailable_female = $this->db->select('*')->from('tbl_registration')->where('photo','')->where('status','1')->where('hmangalyam','1')->where('gender','2')->where('reg_date',$daily_reg_date)->get()->num_rows();?>
               ...
               <?php echo "(Male: $daily_photo_male &nbsp;&nbsp;&nbsp;&nbsp;Female: $daily_photo_female)";?>
                ...
                ->where('staff_id',$assignId)->where('hmangalyam','1')->where('gender','1')->where('reg_date',$tdydate)->get();
                $todaycount2 =  $this->db->select('*')->from('tbl_registration')
                ->where('staff_id',$assignId)->where('hmangalyam','1')->where('gender','2')->where('reg_date',$tdydate)->get();
                ...
                $todaycount =  $this->db->select('*')->from('tbl_registration')
                ->where('home_district','1')->where('gender','1')->where('hmangalyam','1')->where('reg_date',$tdydate)->get();
                $todaycount2 =  $this->db->select('*')->from('tbl_registration')
                ->where('home_district','1')->where('gender','2')->where('hmangalyam','1')->where('reg_date',$tdydate)->get();
                
                $todaycount3 =  $this->db->select('*')->from('tbl_registration')
                ->where('home_district','2')->where('gender','1')->where('hmangalyam','1')->where('reg_date',$tdydate)->get();
                $todaycount4 =  $this->db->select('*')->from('tbl_registration')
                ->where('home_district','2')->where('gender','2')->where('hmangalyam','1')->where('reg_date',$tdydate)->get();
                
                $todaycount5 =  $this->db->select('*')->from('tbl_registration')
                ->where('home_district','3')->where('gender','1')->where('hmangalyam','1')->where('reg_date',$tdydate)->get();
                $todaycount6=  $this->db->select('*')->from('tbl_registration')
                ->where('home_district','3')->where('gender','2')->where('hmangalyam','1')->where('reg_date',$tdydate)->get();  
                
                $todaycount7 =  $this->db->select('*')->from('tbl_registration')
                ->where('home_district','4')->where('gender','1')->where('hmangalyam','1')->where('reg_date',$tdydate)->get();
                $todaycount8=  $this->db->select('*')->from('tbl_registration')
                ->where('home_district','4')->where('gender','2')->where('hmangalyam','1')->where('reg_date',$tdydate)->get(); 
                
                $todaycount9 =  $this->db->select('*')->from('tbl_registration')
                ->where('home_district','5')->where('gender','1')->where('hmangalyam','1')->where('reg_date',$tdydate)->get();
                $todaycount10=  $this->db->select('*')->from('tbl_registration')
                ->where('home_district','5')->where('gender','2')->where('hmangalyam','1')->where('reg_date',$tdydate)->get();  
                
                $todaycount11 =  $this->db->select('*')->from('tbl_registration')
                ->where('home_district','6')->where('gender','1')->where('hmangalyam','1')->where('reg_date',$tdydate)->get();
                $todaycount12=  $this->db->select('*')->from('tbl_registration')
                ->where('home_district','6')->where('gender','2')->where('hmangalyam','1')->where('reg_date',$tdydate)->get();  
                
                
                $todaycount13 =  $this->db->select('*')->from('tbl_registration')
                ->where('home_district','7')->where('gender','1')->where('hmangalyam','1')->where('reg_date',$tdydate)->get();
                $todaycount14=  $this->db->select('*')->from('tbl_registration')
                ->where('home_district','7')->where('gender','2')->where('hmangalyam','1')->where('reg_date',$tdydate)->get();  
                
                $todaycount15 =  $this->db->select('*')->from('tbl_registration')
                ->where('home_district','8')->where('gender','1')->where('hmangalyam','1')->where('reg_date',$tdydate)->get();
                $todaycount16=  $this->db->select('*')->from('tbl_registration')
                ->where('home_district','8')->where('gender','2')->where('hmangalyam','1')->where('reg_date',$tdydate)->get();  
                
                
                $todaycount17 =  $this->db->select('*')->from('tbl_registration')
                ->where('home_district','9')->where('gender','1')->where('hmangalyam','1')->where('reg_date',$tdydate)->get();
                $todaycount18=  $this->db->select('*')->from('tbl_registration')
                ->where('home_district','9')->where('gender','2')->where('hmangalyam','1')->where('reg_date',$tdydate)->get();  
                
                
                $todaycount19 =  $this->db->select('*')->from('tbl_registration')
                ->where('home_district','10')->where('gender','1')->where('hmangalyam','1')->where('reg_date',$tdydate)->get();
                $todaycount20=  $this->db->select('*')->from('tbl_registration')
                ->where('home_district','10')->where('gender','2')->where('hmangalyam','1')->where('reg_date',$tdydate)->get();  
                
                $todaycount21 =  $this->db->select('*')->from('tbl_registration')
                ->where('home_district','11')->where('gender','1')->where('hmangalyam','1')->where('reg_date',$tdydate)->get();
                $todaycount22=  $this->db->select('*')->from('tbl_registration')
                ->where('home_district','11')->where('gender','2')->where('hmangalyam','1')->where('reg_date',$tdydate)->get();  
                
                
                $todaycount23 =  $this->db->select('*')->from('tbl_registration')
                ->where('home_district','12')->where('gender','1')->where('hmangalyam','1')->where('reg_date',$tdydate)->get();
                $todaycount24=  $this->db->select('*')->from('tbl_registration')
                ->where('home_district','12')->where('gender','2')->where('hmangalyam','1')->where('reg_date',$tdydate)->get(); 
                
                $todaycount25 =  $this->db->select('*')->from('tbl_registration')
                ->where('home_district','13')->where('gender','1')->where('hmangalyam','1')->where('reg_date',$tdydate)->get();
                $todaycount26=  $this->db->select('*')->from('tbl_registration')
                ->where('home_district','13')->where('gender','2')->where('hmangalyam','1')->where('reg_date',$tdydate)->get(); 
                
                
                $todaycount27 =  $this->db->select('*')->from('tbl_registration')
                ->where('home_district','14')->where('gender','1')->where('hmangalyam','1')->where('reg_date',$tdydate)->get();
                $todaycount28=  $this->db->select('*')->from('tbl_registration')
                ->where('home_district','14')->where('gender','2')->where('hmangalyam','1')->where('reg_date',$tdydate)->get(); 
            ...
            ->where('staff_id',$assignId)->where('hmangalyam','1')->where('gender','1')->where('MONTH(reg_date)', date('m'))->where('YEAR(reg_date)', date('Y'))->get();
            $totalcount2 =  $this->db->select('*')->from('tbl_registration')
            ->where('staff_id',$assignId)->where('hmangalyam','1')->where('gender','2')->where('MONTH(reg_date)', date('m'))->where('YEAR(reg_date)', date('Y'))->get();
            ...
            $totalcount =  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','1')->where('hmangalyam','1')->where('gender','1')->get();
            $totalcount2 =  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','1')->where('hmangalyam','1')->where('gender','2')->get();
            
            $totalcount3 =  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','2')->where('hmangalyam','1')->where('gender','1')->get();
            $totalcount4 =  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','2')->where('hmangalyam','1')->where('gender','2')->get();
            
            $totalcount5 =  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','3')->where('hmangalyam','1')->where('gender','1')->get();
            $totalcount6=  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','3')->where('hmangalyam','1')->where('gender','2')->get();  
            
            $totalcount7 =  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','4')->where('hmangalyam','1')->where('gender','1')->get();
            $totalcount8=  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','4')->where('hmangalyam','1')->where('gender','2')->get(); 
            
            $totalcount9 =  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','5')->where('hmangalyam','1')->where('gender','1')->get();
            $totalcount10=  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','5')->where('hmangalyam','1')->where('gender','2')->get();  
            
            $totalcount11 =  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','6')->where('hmangalyam','1')->where('gender','1')->get();
            $totalcount12=  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','6')->where('hmangalyam','1')->where('gender','2')->get();  
            
            
            $totalcount13 =  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','7')->where('hmangalyam','1')->where('gender','1')->get();
            $totalcount14=  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','7')->where('hmangalyam','1')->where('gender','2')->get();  
            
            $totalcount15 =  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','8')->where('hmangalyam','1')->where('gender','1')->get();
            $totalcount16=  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','8')->where('hmangalyam','1')->where('gender','2')->get();  
            
            
            $totalcount17 =  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','9')->where('hmangalyam','1')->where('gender','1')->get();
            $totalcount18=  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','9')->where('hmangalyam','1')->where('gender','2')->get();  
            
            
            $totalcount19 =  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','10')->where('hmangalyam','1')->where('gender','1')->get();
            $totalcount20=  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','10')->where('hmangalyam','1')->where('gender','2')->get();  
            
            $totalcount21 =  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','11')->where('hmangalyam','1')->where('gender','1')->get();
            $totalcount22=  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','11')->where('hmangalyam','1')->where('gender','2')->get();  
            
            
            $totalcount23 =  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','12')->where('hmangalyam','1')->where('gender','1')->get();
            $totalcount24=  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','12')->where('hmangalyam','1')->where('gender','2')->get(); 
            
            $totalcount25 =  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','13')->where('hmangalyam','1')->where('gender','1')->get();
            $totalcount26=  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','13')->where('hmangalyam','1')->where('gender','2')->get(); 
            
            
            $totalcount27 =  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','14')->where('hmangalyam','1')->where('gender','1')->get();
            $totalcount28=  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','14')->where('hmangalyam','1')->where('gender','2')->get(); 
