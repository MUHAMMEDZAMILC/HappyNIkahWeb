		...
		<div class="container-xl">
			...
			<div class="row g-4 mb-4">
				<div class="col-6 col-lg-3">
					<div class="app-card app-card-stat shadow-sm h-100">
						<div class="app-card-body p-3 p-lg-4">
							...
							<div class="stats-figure">INR 12,6280000</div>
				...
				<div class="col-6 col-lg-3">
					<div class="app-card app-card-stat shadow-sm h-100">
						<div class="app-card-body p-3 p-lg-4">
							<h4 class="stats-type mb-1">Today Revenue</h4>
							<div class="stats-figure">INR 250000</div>
							<div class="stats-meta text-success">
				...
				<div class="col-6 col-lg-3">
					<div class="app-card app-card-stat shadow-sm h-100">
						<div class="app-card-body p-3 p-lg-4">
							<h4 class="stats-type mb-1">Total Registration</h4>
							<div class="stats-figure">3000 Profiles</div>
				...
				<div class="col-6 col-lg-3">
					<div class="app-card app-card-stat shadow-sm h-100">
						<div class="app-card-body p-3 p-lg-4">
							<h4 class="stats-type mb-1">Verified Profile</h4>
							<div class="stats-figure">800 Profiles</div>
