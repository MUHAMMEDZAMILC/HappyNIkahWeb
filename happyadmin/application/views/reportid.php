                 ...
                 <div class="table-responsive">
                     ...
                     <h3 style="margin-left: 30px;margin-bottom: 35px;margin-top: 20px;">Report Id's</h3>
                      ...
                      <table id="example" class="table app-table-hover mb-0 text-left" style="width:100%">
                        ...
                        $this->db->where('tr_sender.goto_nikah', '0');
                        $this->db->where('tr_sender.hmangalyam', '0');
                        $this->db->where('tr_receiver.goto_nikah', '0');
                    ...
                    <td colspan="2">                                    
                    <a class="btn btn-warning" id="ss" data-interest-id="<?php echo $value['interest_id']; ?>" data-sender-id="<?php echo $value['sender_happynikah_id']; ?>"  data-replace="Solved">Solved</a>
                    <br>
