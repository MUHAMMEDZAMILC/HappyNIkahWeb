...
<div class="app-wrapper">
  ...
  <!-- jQuery -->
        ...
        $.ajax({
        url: '<?php echo base_url('admin/get_date_male_goto'); ?>',
        method: 'post',
        data: formData,
        dataType: 'html',
        ...
        $.ajax({
        type: 'POST',
        url: '<?= base_url() ?>admin/exportToExcel_male_dategoto', // Check this URL path
        data: {
        from_date:from_date,
        to_date:to_date
        },
        ...
        var downloadUrl = '<?= base_url() ?>upload/male_list_dategoto.xlsx?cb=' + cacheBuster;
