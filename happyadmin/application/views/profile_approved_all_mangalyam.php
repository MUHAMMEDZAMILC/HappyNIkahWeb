  ...
  <div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container">
      ...
      <div class="tab-content" id="orders-table-tab-content">
        ...
        <button type="button" class="btn btn-success" id="exporttoall" style="float: right;margin-right: 50px;">Export to Excel</button>     
        <br/>                  
    ...
    'serverMethod': 'post',
    'ajax': {
    'url': '<?= base_url() ?>admin/getFilter_approveprofile_Data_mangalyam',
    'data': function(data) {
    ...
    $('#exporttoall').click(function() 
    {
    $.ajax({
    type: 'POST',
    url: '<?= base_url() ?>admin/allexcel_mangalyam',
    data: {
    ...
    var downloadUrl = '<?= base_url() ?>upload/total.xlsx?cb=' + cacheBuster;
