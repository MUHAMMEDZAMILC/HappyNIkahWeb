			...
			<h1 class="app-page-title">Overview</h1>
				...
				<div class="inner">
					<div class="app-card-body p-3 p-lg-4">
						<h3 class="mb-3">Happy Nikah Creation Dashboard!</h3>
						<div class="row gx-5 gy-3">
							<div class="col-12 col-lg-8">

								<div style="font-family: Bradley Hand, cursive;">Happynikah.com Meet your perfect partner from sites to "tie up together",<br>
