...
<div class="app-wrapper">
    ...
    <div class="container">
      ...
      <div class="tab-content" id="orders-table-tab-content">
        ...
        <!-- The filtered customer data will be appended here -->
           ...
           <button type="button" class="btn btn-success" id="exportto_managalyam" style="display: none;">Export to Excel</button> 
                     </div>   </div>
  ...
  <!-- jQuery -->
        ...
        $.ajax({
        url: '<?php echo base_url('admin/get_femalecount_mangalyam'); ?>',
        method: 'post',
        data: formData,
        dataType: 'html',
        success: function(data) {
        $('#customerData').html(data);
        $("#exportto_managalyam").show();
        }
        });
        });
        
        $('#exportto_managalyam').click(function() {
        districts = $('#districts').val();
        $.ajax({
        type: 'POST',
        url: '<?= base_url() ?>admin/exportToExcel_mangalyam', // Check this URL path
        data: {
        districts:districts
        },
        ...
        var downloadUrl = '<?= base_url() ?>upload/female_list_mangalyam.xlsx?cb=' + cacheBuster;
