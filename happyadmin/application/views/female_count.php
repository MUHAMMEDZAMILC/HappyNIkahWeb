...
<!--     <h4 style="margin-top: 35px;margin-left: 27px;margin-bottom: 23px;font-size:28px;">Female List</h4> -->
    ...
    <p style="margin-left: 30px;margin-right: 30px;
      ...
      border: 2px solid navy;padding: 10px;">Count: <?php echo $total_rows2; ?></p>    
    </div>
<br/><br/>
                
                <h4 style="text-align: center;">District Female List</h4>
                ...
                <td>
                <?php $list_female=$value['reg_date']; ?>
                
                <?php $female=date('d-m-Y',strtotime($list_female));?>
