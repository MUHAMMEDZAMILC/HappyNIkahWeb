  ...
  <div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container">
      ...
      <div class="tab-content" id="orders-table-tab-content">
                    ...
                    <thead>
                      <tr>
                        ...
                        <th class="cell">Name</th>
                         ...
                         <th class="cell">Registeration Through</th>
                    ...
                    //   $where=array('status!='=>'3','reg_through!='=>'1','assign_status!='=>'Inactive');
                      $targetdata=$this->db->select('*')->from('tbl_registration')->where('direct','31')->where('assign_status!=','Inactive')->where('status!=','3')
                                 ->get()->result_array();
                      foreach ($targetdata as $value){ ?>
                        <tr>
                          ...
                          <td class="cell"><?php echo $value['reg_date'];?></td>
                           <td class="cell"><?php if($value['reg_through']==0){
                              echo "Website"; 
                           }if($value['reg_through']==2){
                               echo "Application";
                           }?></td>
                        </tr>
                      <?php
