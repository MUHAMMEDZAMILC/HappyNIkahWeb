	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
			    ...
			    <div class="row g-3 mb-4 align-items-center justify-content-between">
				    <div class="col-auto">
			            <h1 class="app-page-title mb-0">Other States</h1>
				    </div>
				    <div class="col-auto">
            ...
            <button type="submit" class="btn btn-primary">Save changes</button>
				...
				<div class="tab-content" id="orders-table-tab-content">
			        <div class="tab-pane fade show active" id="orders-all" role="tabpanel" aria-labelledby="orders-all-tab">
					   ...
					   <button type="button" class="btn btn-success"  style="color:#fff;margin-left:20px;margin-top: 20px;" id="exportto">
...
<script type="text/javascript">
	...
	$.ajax({
	type: 'POST',
	url: '<?= base_url() ?>admin/otherstate_excel_gotonikah',
	data: {
	...
	var downloadUrl = '<?= base_url() ?>upload/otherstate.xlsx?cb=' + cacheBuster;
