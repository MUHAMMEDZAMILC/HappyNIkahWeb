...
<?php include('header.php'); ?>
 ...
 <?php if($_SESSION['user_type']==='0' &&  $_SESSION['nikah_type']=='happymangalyam')
{
    ...
    <div class="app-wrapper">
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		  ...
		  <path fill-rule="evenodd" d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3z"/>
                ...
                <?php
                  $this->db->select('R.id, R.happynikah_id, R.name, R.phone, R.countryCode, R.reg_date, R.reg_through,R.hmangalyam');
...
<?php include('footer.php'); ?>
 ...
 <script src="<?php echo base_url() ?>assets/plugins/datatables/jquery.dataTables.min.js">
		...
		$.ajax({
		type: 'POST',
		url: '<?= base_url() ?>admin/gulfdata_excel_mangalyam',
		data: {
