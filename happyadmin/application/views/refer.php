            ...
            <div class="container-xl">
                ...
                <div class="tab-content" id="orders-table-tab-content">
                    <div class="tab-pane fade show active" id="orders-all" role="tabpanel" aria-labelledby="orders-all-tab">
                        ...
                        re.status as restatus, re.happynikah_id,re.goto_nikah,re.hmangalyam, d.district_id, d.district AS dist, re.name as reg_name, c.id, c.name AS refercity');
                        ...
                        $this->db->where('r.goto', '0');
                        $this->db->where('re.status', '1');
                        $this->db->where('re.goto_nikah', '0');
                        $this->db->where('re.hmangalyam', '0');
                        ...
                        echo '<th style="color:#fff;">HN ID</th>';
                       ...
                       echo '<td>' . htmlspecialchars($formattedDate) . '</td>';
                        ...
                        // height: 14px;
                        // padding: 10px;
                        // background: hsl(197, 98%, 54%);
                        // padding-top: 6px;
                        // padding-bottom: 6px;
                        // color: #ffffff;
                        // text-align: center;
                        // font: 14px Arial, sans-serif;">' . "Pending" . '</sapn>';
                        // }
                        // echo '<br/>';
                        
                        // if ($data['references'][$j]['status'] === '1') 
                        // {
                        // echo '<span style="border-radius: 50%;
                        // width: 14px;
                        // height: 14px;
                        ...
                        // color: #ffffff;
                        // text-align: center;
                        // font: 14px Arial, sans-serif;">' . "Approved" . '</sapn>';
                        // }
                        ...
                        // echo '<input type="hidden" name="reference_id" value="' . $data['references'][$j]['refer_id'] . '">';
                        // echo '<button type="submit" class="btn btn-danger" style="color:#fff;margin-left: 0px;width: 57%;">Delete
                        // </button>';
