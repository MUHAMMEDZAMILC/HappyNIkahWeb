...
<div class="app-wrapper">
         ...
         <div class="tab-pane fade show active" id="orders-all" role="tabpanel" aria-labelledby="orders-all-tab">
            <div class="app-card app-card-orders-table shadow-sm mb-5">
                <div class="row">
                    ...
                    <a href="<?= base_url() ?>admin/total_postpone" class="btn btn-secondary" style="margin-left: 60px;margin-top: 30px;">Total Postpone</a>
  ...
  <script>
    ...
    window.location.href = "<?php echo base_url('admin/total_postpone'); ?>";
};
  </script>
  </body>
