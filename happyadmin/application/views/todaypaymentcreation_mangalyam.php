  ...
  <div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container">
            ...
            <div class="row mb-2">
              <div class="col-sm-6">
                ...
                <?php
                  ...
                  <!--<h4 style="margin-left: 905px;margin-top: 30px;">Total:<?php echo $totalAmount; ?></h4>-->
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <h4 style="margin-top: 63px;float: right;">Total: ₹<?php echo $totalAmount; ?></h4>
      ...
      <div class="tab-content" id="orders-table-tab-content">
                    ...
                    <div class="col-md-10">
                    <form action="<?php echo base_url('admin/today_staff_filter_mangalyam'); ?>" 
                    method="post">
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td class="cell"><?php echo $value->dt; ?>
