		    ...
		    <div class="container-xl">
				...
				<div class="tab-content" id="orders-table-tab-content">
                  ...
                  <h4   style="margin-left: 25px;margin-top: 10px;">Search ID :<?php echo $hn_id;?></h4>	
                    <?php 
                        $this->db->select('C.*, R1.id AS sender_id,R1.status,R1.hmangalyam,R2.hmangalyam,R1.happynikah_id AS sender_happynikah_id, P.id, P.plan_id, P.description, 
                        R2.id AS receiver_id, R2.happynikah_id AS receiver_happynikah_id,R1.goto_nikah,R2.goto_nikah');
                        ...
                        $this->db->where('R1.goto_nikah', '0');
                        $this->db->where('R2.goto_nikah', '0');
                        
                        $this->db->where('R1.hmangalyam', '1');
                        $this->db->where('R2.hmangalyam', '1');
