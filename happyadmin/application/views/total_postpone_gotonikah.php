...
<div class="app-wrapper">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                            ...
                            <div class="app-card-body">
                              ...
                              <br/>     
                              <br/> 
                              <form action="<?php echo base_url('admin/total_postponeall_gotonikah'); ?>" method="post" style="margin-bottom: -29px;margin-left: 140px;">  
                             <label style="margin-left: 3px;margin-bottom: 10px;">Staff List</label>
                             
                            
                              
                        <?php $targetdata2=$this->db->select('*')->from('tbl_employees1')->where('usertype_id','3')->where('status','1')->get()->result_array();?>
  ...
  <script type="text/javascript">
   ...
   function totalpostpone(){
    ...
    dataType: 'text',
    type: 'POST',
    url: url + 'admin/total_postponeall_gotonikah',
    data: {
    emp_id: emp_id    
    },
