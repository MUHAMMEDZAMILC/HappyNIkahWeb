...
<div class="app-wrapper">
            ...
            <h1 class="app-page-title mb-0" style="margin-left: 50px;">
            Invoice Creation</h1>
				</div>
				...
				<form method="post" action="<?= base_url() ?>admin/invoice_creation">
			...
			<button onclick="window.location.href='<?= base_url() ?>admin/invoice_creation'" name="search_profile_btn" class="btn btn-danger" style="margin-top: 32px;">
        ...
        <div class="card m-4 afour"  style="width: 21cm;height:12cm">
        <div class="card-body">
        <div class="container ">
        ...
        <div class="col-sm-4">
        <ul  class="liststyle">
        <li class=" text1"><span class ="title"><b> Plan </b></span></li>

        <li class=" text1"><span class ="title"><b>
        No of Contacts </b></span></li>

        <li class=" text1"><span class ="title"><b>
        No of Messages </b></span></li>
        <li class=" text1"><span class ="title"><b>
        Duration </b></span></li>
        </ul>
        </div>
        ...
        <?php foreach($query as $profile_value)
        {?>
        <li class=" text1"><span class ="data">
        <?php echo $profile_value['plan_name'];?>
            ...
            <?php echo $total_message;?>
              ...
              <li class=" text1"><span class ="data">
            <?php echo $profile_value['duration'];?>
			...
			<form method="post" action="<?= base_url() ?>admin/generate-invoice-file">
				...
				style="margin: 2px;width: 142px;margin-top: 0px;margin-bottom: 30px;color: white;margin-right: 340px;width:150px;">
			    Download Invoice
				</button>
