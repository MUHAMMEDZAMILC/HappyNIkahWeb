...
<div class="app-wrapper">
   ...
   <!--  <p>This will be fade out after some time... <a href="" onclick="remove_cart('123')" id="id">test</a></p> -->
          ...
          <!--   28-01-2023 10:00 AM -->
           ...
           <!--  
            ...
            <!-- Modal for enter message -->
                ...
                <!--<label for="setting-input-3" class="form-label">Follow up dated</label>      -->
     ...
     <form id="contact" method="post" action="<?php echo base_url(); ?>admin/closeexpirycalls"  onsubmit="setTimeout(function(){window.location.reload();},700);">
