            ...
            <div class="app-card app-card-orders-table shadow-sm mb-5" style="margin-right: -170px;margin-left: 95px;  margin-top: 26px !important;padding-top: 70px;">
            ...
            $registration_query = $this->db->select('id,happynikah_id, name,photo,status,edit_date,edit_through,update_data,goto_nikah,hmangalyam')
            ...
            <!--<img class="profile-image" src="<?php echo base_url();?>'assets/photo_storage/'. $value['photo'];?>" alt="Photo" style="width: 80px;">-->
            ...
            <?php
            if ($updatelog['column_name'] == 'partner_mother_tongue') 
            {
            $mothertongue_id = $updatelog['new_value'];
            ...
            {
            ?>
            <label style="font-size:15px;"><?php echo $result->mothertongue;?></label>
            <?php
            }
            echo "/";
            }
            ...
            <?php
            if ($updatelog['column_name'] == 'partner_marital_status') 
            {
            $mothertongue_id = $updatelog['new_value'];
            ...
            {
            ?>
            <label style="font-size:15px;"><?php echo $result->maritalstatus;?></label>
            <?php
            }
            echo "/";
            }
            ...
            <?php
            if ($updatelog['column_name'] == 'partner_languagespoken') 
            {
            $mothertongue_id = $updatelog['new_value'];
            ...
            <?php
            if ($updatelog['column_name'] == 'religion') 
            {
            $mothertongue_id = $updatelog['new_value'];
            ...
            {
            ?>
            <label style="font-size:15px;"><?php echo $result->religion;?></label>
            <?php
            }
            echo "/";
            }
            ...
            <?php
            if ($updatelog['column_name'] == 'partner_skincolor') 
            {
            $mothertongue_id = $updatelog['new_value'];
            ...
            <label style="font-size:15px;"><?php echo $result->skincolor;?>
            </label>
            <?php
            }
            echo "/";
            ...
            <?php
            if ($updatelog['column_name'] == 'partner_appearance') 
            {
            $mothertongue_id = $updatelog['new_value'];
           ...
           ->select('appearance')
            ...
            <?php
            if ($updatelog['column_name'] == 'partner_caste') 
            {
            $mothertongue_id = $updatelog['new_value'];
            ...
            <?php
            if ($updatelog['column_name'] == 'partner_education') 
            {
            $mothertongue_id = $updatelog['new_value'];
            ...
            <?php
            if ($updatelog['column_name'] == 'partner_occupation') 
            {
            $mothertongue_id = $updatelog['new_value'];
            ...
            <?php
            if ($updatelog['column_name'] == 'caste') 
            {
            $mothertongue_id = $updatelog['new_value'];
            ...
            <?php
            if ($updatelog['column_name'] == 'madrassa_education') 
            {
            $mothertongue_id = $updatelog['new_value'];
            ...
            <?php
            if ($updatelog['column_name'] == 'highest_education') 
            {
            $mothertongue_id = $updatelog['new_value'];
            ...
            ?>
             ...
             <?php
            if ($updatelog['column_name'] == 'education') 
            {
            $mothertongue_id = $updatelog['new_value'];
            ...
            <?php
            if ($updatelog['column_name'] == 'occupation') 
            {
            $mothertongue_id = $updatelog['new_value'];
            ...
            <?php
            if ($updatelog['column_name'] == 'height') 
            {
            $mothertongue_id = $updatelog['new_value'];
            ...
            ?>
             ...
             <?php
            if ($updatelog['column_name'] == 'weight') 
            {
            $mothertongue_id = $updatelog['new_value'];
            ...
            {
            ?>
            <label style="font-size:15px;"><?php echo $result->weight;?></label>
            <?php
            }
            echo "/";
            }
            ...
            <?php
            if ($updatelog['column_name'] == 'mother_tongue') 
            {
            $mothertongue_id = $updatelog['new_value'];
            ...
            <?php
            if ($updatelog['column_name'] == 'native_place') 
            {
            $mothertongue_id = $updatelog['new_value'];
            ...
            {
            ?>
            <label style="font-size:15px;"><?php echo $result->name;?></label>
            <?php
            }
            echo "/";
            }
            ...
            <?php
            if ($updatelog['column_name'] == 'native_district') 
            {
            $mothertongue_id = $updatelog['new_value'];
            ...
            {
            ?>
            <label style="font-size:15px;"><?php echo $result->district;?></label>
            <?php
            }
            echo "/";
            }
            ...
            <?php
            if ($updatelog['column_name'] == 'home_district') 
            {
            $mothertongue_id = $updatelog['new_value'];
            ...
            <?php
            if ($updatelog['column_name'] == 'home_city') 
            {
            $mothertongue_id = $updatelog['new_value'];
            ...
            <?php
            if ($updatelog['column_name'] == 'partner_height') 
            {
            $mothertongue_id = $updatelog['new_value'];
            ...
            {
            ?>
            <label style="font-size:15px;"><?php echo $result->height;?></label>
            <?php
            }
            echo "/";
            }
            ...
            <?php
            if ($updatelog['column_name'] == 'partner_height_to') 
            {
            $mothertongue_id = $updatelog['new_value'];
            ...
            <?php
            if ($updatelog['column_name'] == 'partner_district') 
            {
            $mothertongue_id = $updatelog['new_value'];
            ...
            ?>
            <label style="font-size:15px;">
            <?php echo $result->district;?></label>
            <?php
            }
            echo "/";
            }
            ...
            <?php
            if ($updatelog['column_name'] == 'partner_maritalstatus') 
            {
            $mothertongue_id = $updatelog['new_value'];
            ...
            ?>
            <label style="font-size:15px;">
            <?php echo $result->maritalstatus;?></label>
            <?php
            }
            echo "/";
            }
            ...
            <div class="col-lg-6">
            <form method="post" action="<?= base_url() ?>admin/update_logs">
            ...
            <form method="post" action="<?= base_url() ?>admin/update_logs_delete">
            <div class="form-group">
