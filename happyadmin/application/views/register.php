    ...
    if($user_id=='8' || $_SESSION['user_type']==='3')
    {
...
<script>
      ...
      $(document).ready(function(){
       ...
       <form action="<?php echo site_url('admin/register/Register'); ?>" method="post" autocomplete="off" id="regform">
            ...
            <div class="row">
             ...
             <!-- <div class="row">
              ...
              <div class="app-card-body px-4 w-100 ">
                ...
                <div class="mb-3">
                  <label for="inputName" class="form-label">Caste<font color="red">*</font></label>
              ...
              <div class="app-card-body px-4 w-100">
                ...
                <textarea  id="job_details" required class="form-control" style="height: 50px;" name="job_details" ><?= !empty($ProfileDetails['job_details']) && $ProfileDetails['job_details'] != 'NULL'? $ProfileDetails['job_details'] : '' ?></textarea>
                </div>
        ...
        <div class="col-12 col-lg-6">
          <div class="app-card app-card-account shadow-sm d-flex flex-column align-items-start">
            ...
            <div class="app-card-body px-4 w-100">
              ...
              <input type="text" id="native_place" class="form-control" name="native_place" value="<?= !empty($ProfileDetails['native_place']) ? $ProfileDetails['native_place'] : '' ?>" required>
...
$(".partner_age_from").change(function() {
      ...
      if (partner_age_from != '') {
        ...
        $(".partner_age_to").append('<option value="" selected disabled>-Select-</option>');
 ...
 var country = $('#partner_country').val();
    ...
    if (country != '') {
      $("#partner_state").empty();
      $("#partner_state").append('<option value="" selected disabled>-Select-</option>');
      $.ajax({
