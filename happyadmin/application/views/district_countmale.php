...
<script>
  ...
  $(document).ready(function() {
    $('#filterForm').submit(function(e) {
      ...
      $.ajax({
        url: '<?php echo base_url('admin/get_malecount'); ?>',
        method: 'post',
        data: formData,
        dataType: 'html',
 ...
 $('#exportto_male').click(function() {
  districts = $('#districts').val();
    $.ajax({
        type: 'POST',
        url: '<?= base_url() ?>admin/exportToExcel_male', // Check this URL path
        data: {
           districts:districts
        },
        ...
        var downloadUrl = '<?= base_url() ?>upload/male_list.xlsx?cb=' + cacheBuster;
