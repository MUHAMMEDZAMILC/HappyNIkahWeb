...
<div class="app-wrapper">
    ...
    <div class="app-content pt-3 p-md-3 p-lg-4">
        ...
        <div class="row g-3 mb-4 align-items-center justify-content-between">
            ...
            <div class="card-body">
                     <!--<h1 class="app-page-title mb-0">DoorStep Collection</h1>-->
             
              <?php 
            $this->db->select('tbl_registration.happynikah_id,tbl_registration.age,tbl_registration.goto_nikah,tbl_registration.hmangalyam,tbl_registration.marital_status,
