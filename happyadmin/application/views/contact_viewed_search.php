...
<style>
        ...
        .please h5 {
          ...
          <div class="app-wrapper">
				...
				<form method="post" action="<?= base_url() ?>admin/contact_viewed_listing">
				...
				<button onclick="window.location.href='<?= base_url() ?>admin/contact_viewed_listing'" name="search_profile_btn" class="btn btn-danger" style="margin-top: 32px;">
