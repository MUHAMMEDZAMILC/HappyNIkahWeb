...
<div class="app-wrapper">
    ...
    <div class="container">
      <div class="row g-3 mb-4 align-items-center justify-content-between">
        ...
        <!-- Main content -->
                ...
                <a href="<?= base_url() ?>admin/total_postpone_mangalyam" class="btn btn-secondary" style="margin-left: 60px;margin-top: 30px;">Total Postpone</a>
                ...
                <?php
                $i = 1;
                foreach ($totalpostpone as $value)
                { ?>
                <tr>
  ...
  <script>
    ...
    window.location.href = "<?php echo base_url('admin/total_postpone_mangalyam'); ?>";
};
  </script>
  </body>
