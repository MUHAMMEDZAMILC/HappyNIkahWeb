	...
	<div class="app-content pt-3 p-md-3 p-lg-4">
			...
			<div class="app-card alert alert-dismissible shadow-sm mb-4 border-left-decoration" role="alert">
				<div class="inner">
					<div class="app-card-body p-3 p-lg-4">
						<h3 class="mb-3">Happy Nikah Support Admin Dashboard!</h3>
      ...
      <div class="row g-4 mb-4">
        ...
        <?php $photoavailfemale_count = $photo_availbale_female->row()->total_count;?>
                ...
                <?php $photo_availbale_female = $this->db->query("SELECT COUNT(*) AS total_count FROM tbl_registration R WHERE EXISTS (SELECT * FROM tbl_userimages U WHERE R.id = U.user_id) AND R.status = '1'  AND R.goto_nikah = '0'  AND R.gender='2' AND R.photo!= ''");?>
                <?php $photoavailfemale_count = $photo_availbale_female->row()->total_count;?>
               ...
               <?php echo "(Male: $daily_photo_male &nbsp;&nbsp;&nbsp;&nbsp;Female: $daily_photo_female)";?>
                ...
                ->where('staff_id',$assignId)->where('goto_nikah','0')->where('gender','1')->where('reg_date',$tdydate)->get();
                $todaycount2 =  $this->db->select('*')->from('tbl_registration')
                ->where('staff_id',$assignId)->where('goto_nikah','0')->where('gender','2')->where('reg_date',$tdydate)->get();
        ...
        ?>
           ...
           <tr>
            ...
            <tbody>
                ...
                ->where('staff_id',$assignId)->where('goto_nikah','0')->where('gender','1')->where('MONTH(reg_date)', date('m'))->where('YEAR(reg_date)', date('Y'))->get();
                 $totalcount2 =  $this->db->select('*')->from('tbl_registration')
                ->where('staff_id',$assignId)->where('goto_nikah','0')->where('gender','2')->where('MONTH(reg_date)', date('m'))->where('YEAR(reg_date)', date('Y'))->get();
    ...
    $totalmonthlyFemaleCount += $totalcount2->num_rows();
        ...
        ?>
           ...
           <tr>
            ...
            $totalcount =  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','1')->where('goto_nikah','0')->where('gender','1')->get();
            $totalcount2 =  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','1')->where('goto_nikah','0')->where('gender','2')->get();
            
            $totalcount3 =  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','2')->where('goto_nikah','0')->where('gender','1')->get();
            $totalcount4 =  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','2')->where('goto_nikah','0')->where('gender','2')->get();
            
            $totalcount5 =  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','3')->where('goto_nikah','0')->where('gender','1')->get();
            $totalcount6=  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','3')->where('goto_nikah','0')->where('gender','2')->get();  
            
            $totalcount7 =  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','4')->where('goto_nikah','0')->where('gender','1')->get();
            $totalcount8=  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','4')->where('goto_nikah','0')->where('gender','2')->get(); 
            
            $totalcount9 =  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','5')->where('goto_nikah','0')->where('gender','1')->get();
            $totalcount10=  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','5')->where('goto_nikah','0')->where('gender','2')->get();  
            
            $totalcount11 =  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','6')->where('goto_nikah','0')->where('gender','1')->get();
            $totalcount12=  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','6')->where('goto_nikah','0')->where('gender','2')->get();  
            
            
            $totalcount13 =  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','7')->where('goto_nikah','0')->where('gender','1')->get();
            $totalcount14=  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','7')->where('goto_nikah','0')->where('gender','2')->get();  
            
            $totalcount15 =  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','8')->where('goto_nikah','0')->where('gender','1')->get();
            $totalcount16=  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','8')->where('goto_nikah','0')->where('gender','2')->get();  
            
            
            $totalcount17 =  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','9')->where('goto_nikah','0')->where('gender','1')->get();
            $totalcount18=  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','9')->where('goto_nikah','0')->where('gender','2')->get();  
            
            
            $totalcount19 =  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','10')->where('goto_nikah','0')->where('gender','1')->get();
            $totalcount20=  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','10')->where('goto_nikah','0')->where('gender','2')->get();  
            
            $totalcount21 =  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','11')->where('goto_nikah','0')->where('gender','1')->get();
            $totalcount22=  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','11')->where('goto_nikah','0')->where('gender','2')->get();  
            
            
            $totalcount23 =  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','12')->where('goto_nikah','0')->where('gender','1')->get();
            $totalcount24=  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','12')->where('goto_nikah','0')->where('gender','2')->get(); 
            
            $totalcount25 =  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','13')->where('goto_nikah','0')->where('gender','1')->get();
            $totalcount26=  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','13')->where('goto_nikah','0')->where('gender','2')->get(); 
            
            
            $totalcount27 =  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','14')->where('goto_nikah','0')->where('gender','1')->get();
            $totalcount28=  $this->db->select('*')->from('tbl_registration')
            ->where('home_district','14')->where('goto_nikah','0')->where('gender','2')->get(); 
