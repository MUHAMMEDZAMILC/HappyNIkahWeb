            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                 ...
                 <h4 style="margin-top: 63px;float: right;">Filtered Amount: ₹<?php echo isset($filteredtotal->famount) ? $filteredtotal->famount : 0; ?></h4>
                    ...
                    <div class="tab-pane fade show active" id="orders-all" role="tabpanel" aria-labelledby="orders-all-tab">
                        <div class="app-card app-card-orders-table shadow-sm mb-5">
                            <div class="app-card-body">
                               ...
                               <a href="<?php echo base_url();?>admin/totalpaymentcreation" class="btn btn-primary" style="margin-left: 30px;margin-top: 10px;">Total Sale</a> 
                ...
                <tr>
                    ...
                    <td class="cell"><?php echo $i; ?></td>
                          ...
                          <td class="cell">
                           ...
                           <?php $pay_date=$item->date;?>   
                         <?php $post_date_new=date('d-m-Y',strtotime($pay_date));?>
                         <?php echo $post_date_new;?>
                           ...
                           <td class="cell"><?php echo $item->final_amount; ?></td>
