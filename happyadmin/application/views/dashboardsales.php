...
<div class="app-wrapper">
    ...
    <div class="app-content pt-3 p-md-3 p-lg-4">
        <div class="container-xl">
            ...
            <div class="app-card alert alert-dismissible shadow-sm mb-4 border-left-decoration" role="alert">
                <div class="inner">
                    <div class="app-card-body p-3 p-lg-4">
                        ...
                        <h3 class="mb-3">Happy Nikah Sales Admin Dashboard</h3>
            ...
            WHERE tbl_payement.status='1'  AND tbl_payement.payment_staff_id='$user_id'  AND tbl_payement.payment_status='Paid'  AND tbl_registration.goto_nikah = 0")->row();?>
            ...
            ->where('tbl_registration.goto_nikah', 0)
            ->get()
            ->num_rows();?>
            <!--11354.77-->
