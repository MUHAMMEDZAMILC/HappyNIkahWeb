               ...
               <li class="nav-item has-submenu">
							...
							<div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
								<ul class="submenu-list list-unstyled">
									<li class="submenu-item"><a class="submenu-link" style="text-decoration: none;" href="<?php echo site_url('admin/tdycreation'); ?>">Today's Creation
										</a></li>

								</ul>
								<ul class="submenu-list list-unstyled">
									<li class="submenu-item"><a class="submenu-link" style="text-decoration: none;" href="<?php echo site_url('admin/totalcreation'); ?>">Total Creation
										</a></li>
