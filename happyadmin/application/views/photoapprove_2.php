                   ...
                   $i=1;
                    ...
                    ?>
                        <tr>
                          ...
                          <img src="https://happynikah.azurewebsites.net/api/Files/photo_storage/?filePath=<?php echo $val->user_image; ?>" style="width:50px;"></td>
                          
                          
                          <td class="cell"> <?php echo $profile['happynikah_id']; ?> 
                          </td>
                        ...
                        <a target="_blank" href="https://happynikah.azurewebsites.net/api/Files/photo_storage/?filePath=<?php echo $val->user_image; ?>"
...
?>
  ...
  <div class="modal fade" id="modal_form_<?php echo $val->user_image_id; ?>" role="dialog">
    ...
    <input type="hidden" name="url" id="url_<?php echo $val->user_image_id ?>"  value="<?php echo base_url() ?>../assets/photo_storage/<?php echo $val->user_image; ?>">
