  ...
  <div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container">
      <div class="row g-3 mb-4 align-items-center justify-content-between">
        ...
        <button type="button" class="btn btn-success" id="exportButton" style="margin-left: 750px;margin-top: 0px;">Export to Excel</button> 
    ...
    <!--</div>-->
        ...
        'serverMethod': 'post',
        'ajax': {
        'url': '<?= base_url() ?>admin/getFilter_noprofilephoto_Data',
        'data': function(data) {
        ...
        $.ajax({
        type: 'POST',
        url: '<?= base_url() ?>admin/createExcel_nophoto',
        data: {
