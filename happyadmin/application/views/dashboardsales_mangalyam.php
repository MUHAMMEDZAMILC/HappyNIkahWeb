<?php include('header.php'); ?>
 ...
 <?php include('menusales_mangalyam.php'); ?>
            ...
            <div class="app-card alert alert-dismissible shadow-sm mb-4 border-left-decoration" role="alert">
                <div class="inner">
                    <div class="app-card-body p-3 p-lg-4">
                        ...
                        <h3 class="mb-3">Happymangalyam Sales Admin Dashboard</h3>
                        <div class="row gx-5 gy-3">
                            <div class="col-12 col-lg-8">

                                <div style="font-family: Bradley Hand, cursive;">Happymangalyam.com Meet your perfect partner from sites to "tie up together",<br>
                ...
                <div class="col-6 col-lg-3">
                    <div class="app-card app-card-stat shadow-sm h-100" style="border-left: 3px solid orange">
                        ...
                        <?php $total_acheive = $this->db->query("SELECT SUM(tbl_payement.final_amount) as total FROM tbl_payement INNER JOIN tbl_registration ON tbl_registration.id = tbl_payement.user_id 
                                               WHERE tbl_payement.status='1'  AND tbl_payement.payment_staff_id='$user_id'  AND tbl_payement.payment_status='Paid'  AND tbl_registration.hmangalyam = 1")->row();?>
