    ...
    <div class="container">
      ...
      <div class="tab-content" id="orders-table-tab-content">
                    <div class="tab-pane fade show active" id="orders-all" role="tabpanel" aria-labelledby="orders-all-tab">
                     ...
                     <a href="<?php echo base_url();?>admin/totalpaymentcreation_mangalyam" class="btn btn-primary" style="margin-left: 690px;margin-top: -49px;width: 135px;;">Total Sale</a> 
                        </div>
                        </div>
                        </div>   
