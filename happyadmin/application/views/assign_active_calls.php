  ...
  <div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container">
      ...
      <div class="tab-content" id="orders-table-tab-content">
          ...
          <form action="<?php echo base_url();?>admin/assign_active_calls_form"  method="post">
        ...
        <input type="submit" id="save-project-btn3" name="submit" class="btn btn-primary" style="margin-left: 670px;margin-top:-66px;">   
            ...
            <?php $todayassigned = $this->db->select('*')->from('tbl_assign_active_calls')->where('goto_status',0)->where('date',$todaydate)->get()->num_rows();?>
            ...
            'serverMethod': 'post',
            'ajax': {
            'url': '<?= base_url() ?>admin/getFilter_assign_activecallsData',
            'data': function(data) {
