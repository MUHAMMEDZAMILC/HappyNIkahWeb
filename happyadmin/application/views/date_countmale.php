  ...
  <div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container">
      ...
      <div class="tab-content" id="orders-table-tab-content">
              ...
              <button type="button" class="btn btn-success" id="exportto_male" style="display: none;">Export to Excel</button>
                     </div>   </div>
...
<script>
  ...
  $(document).ready(function() {
    $('#filterForm').submit(function(e) {
      ...
      $.ajax({
        url: '<?php echo base_url('admin/get_date_male'); ?>',
        method: 'post',
        data: formData,
        dataType: 'html',
 ...
 $('#exportto_male').click(function() {
  from_date = $('#from_date').val();
  to_date = $('#to_date').val();
    $.ajax({
        type: 'POST',
        url: '<?= base_url() ?>admin/exportToExcel_male_date', // Check this URL path
        data: {
           from_date:from_date,
           to_date:to_date
        },
        ...
        var downloadUrl = '<?= base_url() ?>upload/male_list_date.xlsx?cb=' + cacheBuster;
