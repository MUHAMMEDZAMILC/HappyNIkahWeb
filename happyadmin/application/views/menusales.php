<div id="app-sidepanel" class="app-sidepanel sidepanel-hidden">
        ...
        <nav id="" class="app-nav app-nav-main flex-grow-1">
            ...
            {?>
                ...
                <li class="nav-item has-submenu">
							<!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
							<a class="nav-link submenu-toggle" href="#" data-bs-toggle="collapse" data-bs-target="#submenu-111" aria-expanded="true" aria-controls="submenu-111">
								<span class="nav-icon">
									<!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
							...
							<!--//nav-link-->
							<div id="submenu-111" class="collapse submenu submenu-111" data-bs-parent="#menu-accordion">
    ...
    <?php $user_id=$this->session->userdata('user_id_admin');
            ...
            {?>
                <li class="nav-item">
                    ...
                    <a class="nav-link" href="<?php echo site_url('admin/approvecalls');?>">
                        <span class="nav-icon">
                        ...
                        <span class="nav-link-text">Approve calls</span>
                    </a>
 ...
 <?php $user_id=$this->session->userdata('user_id_admin');
            ...
            {?>
                <li class="nav-item">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link" href="<?php echo site_url('admin/activecalls'); ?>">
                        <span class="nav-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-telephone" viewBox="0 0 16 16">
                                <path d="M3.654 1.328a.678.678 0 0 0-1.015-.063L1.605 2.3c-.483.484-.661 1.169-.45 1.77a17.568 17.568 0 0 0 4.168 6.608 17.569 17.569 0 0 0 6.608 4.168c.601.211 1.286.033 1.77-.45l1.034-1.034a.678.678 0 0 0-.063-1.015l-2.307-1.794a.678.678 0 0 0-.58-.122l-2.19.547a1.745 1.745 0 0 1-1.657-.459L5.482 8.062a1.745 1.745 0 0 1-.46-1.657l.548-2.19a.678.678 0 0 0-.122-.58L3.654 1.328zM1.884.511a1.745 1.745 0 0 1 2.612.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z" />
                            </svg>
                        </span>
                        <span class="nav-link-text">Active calls</span>
                    </a>
                    <!--//nav-link-->
                </li>
              <?php }?>
               ...
               <?php if($user_id=='8' || $user_id=='26')
                {?>
                 ...
                 <li class="nav-item">
                    ...
                    <span class="nav-link-text">Profile Approvel</span>
                    <span class="submenu-arrow">
                    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-chevron-down" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"></path>
                    </svg>
            ...
            {?>
				...
				<li class="nav-item has-submenu">
                    ...
                    <ul class="submenu-list list-unstyled">
                    <li class="submenu-item"><a class="submenu-link" style="text-decoration: none;" href="<?php echo site_url('admin/todaycreation'); ?>">Today Approved Profile</a></li>
                    <li class="submenu-item"><a class="submenu-link" style="text-decoration: none;" href="<?php echo site_url('admin/photoapprove'); ?>">Photo Approvels </a></li>
                      ...
                      <li class="submenu-item"><a class="submenu-link" style="text-decoration: none;" href="<?php echo site_url('admin/profile_approvals_all'); ?>"> Approved Profile
                    </a>
                    </li>
                ...
                <!--//nav-link-->
                 ...
                 <li class="nav-item">
                <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                <a class="nav-link" href="<?php echo site_url('admin/update_logs'); ?>">
                <span class="nav-icon">
                ...
                <span class="nav-link-text">Pending Profile Update</span>
                </a>
                <!--//nav-link-->
                </li>
            ...
            <li class="nav-item">
            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
            <a class="nav-link" href="<?php echo site_url('admin/district_date_staff_count_form'); ?>">
            <span class="nav-icon">
		...
		<?php }?>
                ...
                <span class="nav-link-text">Today Followup</span>
                </a>
                <!--//nav-link-->
                </li>
                ...
                <span class="nav-link-text">Pending Followup</span>
                </a>
                <!--//nav-link-->
                </li>
                ...
                <li class="nav-item">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link" href="<?php echo site_url('admin/paymentdetails') ?>">
                        <span class="nav-icon">
                ...
                <li class="nav-item">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link" href="<?php echo site_url('admin/payvisit_customer') ?>">
                        <span class="nav-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-currency-rupee" viewBox="0 0 16 16">
                                <path d="M4 3.06h2.726c1.22 0 2.12.575 2.325 1.724H4v1.051h5.051C8.855 7.001 8 7.558 6.788 7.558H4v1.317L8.437 14h2.11L6.095 8.884h.855c2.316-.018 3.465-1.476 3.688-3.049H12V4.784h-1.345c-.08-.778-.357-1.335-.793-1.732H12V2H4v1.06Z" />
                            </svg>
                        </span>
                        <span class="nav-link-text">Pay Visit List</span>
                    </a>
                    <!--//nav-link-->
                </li>
                <?php }?>
                ...
                <li class="nav-item">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link" href="<?php echo site_url('admin/expirycalls') ?>">
                        <span class="nav-icon">
                        ...
                        <span class="nav-link-text">Expiry Calls</span>
                    </a>
                    <!--//nav-link-->
                </li>
                <?php }?>
                ...
                <li class="nav-item">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link" href="<?php echo site_url('admin/lastlogin'); ?>">
                        <span class="nav-icon">
                        ...
                        <span class="nav-link-text">Last login</span>
                    </a>
                    <!--//nav-link-->
                </li>
