...
?>
     ...
     <!-- Font Awesome -->
        ...
        re.status as restatus, re.happynikah_id,re.hmangalyam,d.district_id, d.district AS dist, re.name as reg_name, c.id, c.name AS refercity');
        ...
        $this->db->where('r.goto', '2');
        $this->db->where('re.status', '1');
        $this->db->where('re.hmangalyam', '1');
        ...
        'goto' => $row['goto']
                        ...
                        echo '<th style="color:#fff;">HM ID</th>';
