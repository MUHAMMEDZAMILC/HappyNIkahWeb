							    ...
							    <div class="table-responsive">
							        <table id="example" class="table app-table-hover mb-0 text-left">
										<thead style="background-color: grey;border:1px solid black;">
											<tr>
												<th style="color:#fff;" class="cell">Sl No</th>
													<th style="color:#fff;" class="cell">HN ID</th>
												<th style="color:#fff;" class="cell">Name</th>
												<th style="color:#fff;" class="cell">Mobile</th>
												<th style="color:#fff;">Date</th>
												<!-- <th class="cell">Status</th> -->
												<th style="color:#fff;" class="cell">Actions</th>
											</tr>
										</thead>
										<tbody>
										<?php
										 ...
										 foreach ($register as $key=>$value) { ?>
											<tr id"trr">
												...
												<td class="cell"><span class="truncate"><?php echo $value->name; ?></span></td>
												<td class="cell"><?php if($value->countryCode!= '0'){$countryCode = "+".$value->countryCode; }else{$countryCode="";} echo $countryCode.$value->phone; ?></td>
