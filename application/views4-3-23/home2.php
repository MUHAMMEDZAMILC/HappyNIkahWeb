                    ...
                    <div class="regBox">
                        ...
                        { ?>
                            ...
                            <div class="error_bg" id="reg_error" style="margin-left: auto;margin-right: auto;width: 70%;display: none;">
                                <a id="notidiv" data-bs-toggle="modal" style="color: #000000;width: 100%;text-align: center;float: left;/*background: #ab3030a3;*/font-weight: 700;" data-bs-target="#loginModal" style="margin-bottom:20px;"><span id="error-mob"></span> is already registered<b style="background: #FF5B85; color: white; padding: 3px 11px; border-radius: 4px; float: right; margin-bottom: 25px; margin-right: 36px;">Login Now</b></a>
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-3 mb-5 mb-md-0">
                    ...
                    <ul class="flinks">
                        ...
                        <li>
                            <a href="https://happynikah.com/user/terms">Terms and Conditions</a>
                        </li>
                        <li>
