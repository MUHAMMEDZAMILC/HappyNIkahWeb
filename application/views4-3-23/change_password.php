            ...
            <div class="row d-flex justify-content-center">
                ...
                <div class="col-12 col-md-5 d-flex align-items-center">
                    <div class="w-100">
                        ...
                        <?php if($this->session->flashdata('pass_mismatch') != ''){ $error = 'Password and Confirm Password Mismatch'; }  ?>
                        ...
                        <form class="customForm" action="<?php echo site_url('user/changepassword'); ?>" method="post">
                            <div class="mb-3">
