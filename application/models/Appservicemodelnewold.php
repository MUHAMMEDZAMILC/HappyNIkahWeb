...
//   echo $p;	
    ...
    public function sendPushNotification($token, $title, $body, $id,$type) {
        ...
        $SERVER_API_KEY ='AAAA1m_wSGo:APA91bHbewjLbRcMQVr6nfI2jA40mxHlQBArA-pUovyigtENhcHWrW7-QtKG0aOnwbvRrzmOUR3DCgevDwoEdf4yEQnbSUbeRiMINjVP382MdKg5oD8PIPWOmxXjiQ-Nfx8rtC0NwUh5';
