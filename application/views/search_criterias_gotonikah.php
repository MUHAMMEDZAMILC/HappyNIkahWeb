...
<?php include('include/user_header_gotonikah.php'); ?>
    ...
    <section id="userContent">
        <div class="container">
            ...
            <div class="tab-content searchTabContent">
                <div class="tab-pane fade show active" id="searchProfile" role="tabpanel" aria-labelledby="searchProfile-tab">
                    <form class="customForm"  action="<?php echo site_url('user/search_profile_common_gotonikah'); ?>" method="post" autocomplete="off">
                        <div class="row">
                            <div class="col-12 col-md-6 col-lg-4 mb-4 px-4">
                                <label for="ageSlider-1" class="form-label" style="color:#5ABA47;">Age</label>
                                <div class="wrapper mb-4">
                                    ...
                                    <div class="container1">
                                        <div class="sliderTrack age-slider-track"  id="track"></div>
                            ...
                            <div class="col-12 col-md-6 col-lg-4 mb-4 px-4">
                                <label for="hightSlider-1" class="form-label" style="color:#5ABA47;">Height</label>
                                <div class="wrapper mb-4">
                                    <div class="values">
                                        <span id="hightRange1">125</span>
                                        <span id="hightRange2">212</span>
                                    </div>
                                    <div class="container1">
                                        <div class="sliderTrack hight-slider-track" id="trackheight"></div>
                            ...
                            <div class="col-12 col-md-6 col-lg-4 mb-4 px-4">
                                <label class="form-label" style="color:#5ABA47;">Marital Status</label>
                    ...
                    <?php } ?>
                            ...
                            <div class="col-12 col-md-6 col-lg-4 mb-4 px-4">
                                <label class="form-label" style="color:#5ABA47;">Highest Education</label>
                    ...
                    <?php } ?>  
                            ...
                            <div class="col-12 col-md-6 col-lg-4 mb-4 px-4">
                                <label class="form-label" style="color:#5ABA47;">Country</label>
                    ...
                    <?php } ?>  
                              ...
                              <div class="col-12 col-md-6 col-lg-4 mb-4 px-4">
                                <label class="form-label" style="color:#5ABA47;">State</label>
                            ...
                            <div class="col-12 col-md-6 col-lg-4 mb-4 px-4">
                                <label class="form-label" style="color:#5ABA47;">District</label>
                           ...
                           <!-- <div class="col-12 col-md-6 col-lg-4 mb-4 px-4">
                                ...
                                <select class="form-select form-control" aria-label="" name="city[]" id="city" multiple style="height:40px;">
                                <option value="">--Select--</option>
                ...
                <div class="tab-pane fade" id="advancedSearch" role="tabpanel" aria-labelledby="advancedSearch-tab">
                    <form class="customForm" action="<?php echo site_url('user/search_profile_advanced_gotonikah'); ?>" method="post" autocomplete="off">
                        <div class="row">
                            <div class="col-12 col-md-6 col-lg-4 mb-4 px-4">
                                <label for="age1Slider-1" class="form-label" style="color:#5ABA47;">Age</label>
                                <div class="wrapper mb-4">
                                    <div class="values">
                                        <span id="age1Range1">18</span>
                                        <span id="age1Range2">60</span>
                                    </div>
                                    <div class="container1">
                                        <div class="sliderTrack age1-slider-track" id="track1"></div>
                            ...
                            <div class="col-12 col-md-6 col-lg-4 mb-4 px-4">
                                <label for="hight1Slider-1" class="form-label" style="color:#5ABA47;">Height</label>
                                <div class="wrapper mb-4">
                                    <div class="values">
                                        <span id="hight1Range1">125</span>
                                        <span id="hight1Range2">212</span>
                                    </div>
                                    <div class="container1">
                                        <div class="sliderTrack hight1-slider-track" id="trackheight1"></div>
                            ...
                            <div class="col-12 col-md-6 col-lg-4 mb-4 px-4">
                                <label for="weightSlider-1" class="form-label" style="color:#5ABA47;">Weight</label>
                                <div class="wrapper mb-4">
                                    <div class="values">
                                        <span id="weightRange1">40</span>
                                        <span id="weightRange2">150</span>
                                    </div>
                                    <div class="container1">
                                        <div class="sliderTrack weight-slider-track" id="trackweight1"></div>
                            ...
                            <div class="col-12 col-md-6 col-lg-4 mb-4 px-4">
                                <label class="form-label" style="color:#5ABA47;">Marital Status</label>
                                <select class="form-select form-control" aria-label="" id="marital_status1" name="marital_status[]" multiple>
                                                    <option value="Any">--Any--</option>
                    <?php foreach ($maritalstatus as $value) { ?>
                    <option value="<?php echo $value->maritalstatus ?>"  <?= (isset($BasicDetails->marital_status) && !empty($BasicDetails->marital_status)) ? ($BasicDetails->marital_status == $value->maritalstatus ? 'selected' : '') : '' ?> ><?php echo $value->maritalstatus; ?></option>  
                    <?php } ?>
                            ...
                            <div class="col-12 col-md-6 col-lg-4 mb-4 px-4">
                                <label class="form-label" style="color:#5ABA47;">Body Type</label>
                  ...
                  <?php } ?>
                            ...
                            <div class="col-12 col-md-6 col-lg-4 mb-4 px-4">
                                <label class="form-label" style="color:#5ABA47;">Skin Colour</label>
                  ...
                  <?php } ?>
                            ...
                            <div class="col-12 col-md-6 col-lg-4 mb-4 px-4">
                                <label class="form-label" style="color:#5ABA47;">Financial Status</label>
                    ...
                    <?php } ?>
                            ...
                            <div class="col-12 col-md-6 col-lg-4 mb-4 px-4">
                                <label class="form-label" style="color:#5ABA47;">Belief</label>
            <select id="adv_belief" class="form-control custom-select" name="adv_belief[]"  multiple>
                    ...
                    <?php } ?>  
                            ...
                            <div class="col-12 col-md-6 col-lg-4 mb-4 px-4">
                                <label class="form-label" style="color:#5ABA47;">Physical Status</label>
                    ...
                    <option value="<?php echo $value->id ?>" ><?php echo $value->physicalstatus; ?></option>  
                    <?php } ?>
...
-->                                </select>
                            ...
                            <div class="col-12 col-md-6 col-lg-4 mb-4 px-4">
                                <label class="form-label" style="color:#5ABA47;">City</label>
                            ...
                            <div class="col-12 col-md-6 col-lg-4 mb-4 px-4">
                                <label class="form-label" style="color:#5ABA47;">Job Category</label>
                    ...
                    <?php } ?>  
                            ...
                            <div class="col-12 col-md-6 col-lg-4 mb-4 px-4">
                                <label class="form-label" style="color:#5ABA47;">Show Profile</label>
                            ...
                            <div class="col-12 col-md-6 col-lg-4 mb-4 px-4">
                                <label class="form-label" style="color:#5ABA47;">Sort by</label>
                                <select class="form-select form-control" aria-label="" name="sort_by">
                                    <option value="1">Recent Logins</option>
                                    <option value="2">Recent Registrations</option>
                                </select>
                            </div>
                            ...
                            <button class="btn searchBtn" type="submit" style="color: #fff;font-size: 14px;font-family: Roboto, sans-serif;background: #5ABA47;;border-radius: 5px;width: 100%;margin-top: 32px;" >
                ...
                <div class="tab-pane fade" id="idSearch" role="tabpanel" aria-labelledby="idSearch-tab">
                    <form class="customForm searchByIdOnly" action="<?php echo site_url('user/search_profile_id'); ?>" method="post" autocomplete="off">
                        <div class="row">
                        ...
                        <button class="btn searchBtn" type="submit" style="color: #fff;font-size: 14px;font-family: Roboto, sans-serif;background: #5ABA47;
                            margin-left: 180px;border-radius: 5px;width: 48%;margin-top: 32px;">
   ...
   div#track
   {
    background:linear-gradient(to right, rgb(218, 218, 229) 0%, rgb(90 186 71) 0%, rgb(90 186 71) 100%, rgb(218, 218, 229) 100%) !important;   
   }
   div#trackheight{
    background:linear-gradient(to right, rgb(218, 218, 229) 0%, rgb(90 186 71) 0%, rgb(90 186 71) 100%, rgb(218, 218, 229) 100%) !important;   
   }
   #userContent .wrapper .values span {
    position: absolute;
    top: 0;
    color: #5ABA47;

}
#userContent .searchTabContent .searchBtn {
    color: #fff;
    font-size: 14px;
...
#userContent .searchTabs .nav-link.active {
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.13.1/js/bootstrap-select.min.js"></script>   <script type="text/javascript">
...
$('#highest_education option').prop('selected', true);
        ...
        if($( "#adv_highest_education" ).val()=="Any")    
        {
