...
<body>
    ...
    <section id="banner">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-lg-5 col-md-12 d-flex align-items-center">
                    <div class="regBox">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-10" style="margin-left: 40px;">
                                ...
                                <input type="text" class="form-control" placeholder="Bride / Groom Name *" id="name" name="name" onkeypress="return lettersOnly(event)">
                        ...
                        <div class="col-12 col-md-10" style="margin-left: 39px;">
                            <div class="form-control">
                                ...
                                <span>
                                    <select style="width: auto;margin-left:30px;border-color:white;" name="age" id="age">
                                        <option>Age</option>
                                        <option>18</option>
                                        <option>19</option>
                                        <option>20</option>
                        ...
                        <!--<div class="col-md-6">-->
                        <!-- <div class="form-check-inline custom_radio form-control">
                                    <input class="form-check-input" type="radio" name="gender" id="male" value="1">
                                    <label class="form-check-label" for="male">Male</label>
                                </div>
                                <div class="form-check-inline custom_radio form-control">
                        ...
                        <div class="row" style="margin-left: 26px;">
                            ...
                            <div class="col-lg-8 col-md-10s">
                                ...
                                <input style="margin-left:114px;margin-top:21px;" type="text" class="form-control" placeholder="Phone Number" id="phone" name="phone" maxlength="10" onkeypress="return event.charCode > 47 && event.charCode < 58;">
                        ...
                        { ?>
                            ...
                            <!--<a id="notidiv" data-bs-toggle="modal" style="color: red; width: 100%; text-align: center;  float: left;" data-bs-target="#loginModal" style="margin-bottom:20px;"><?php //echo $_GET['status']; 
                                                                                                                                                                                                    ?>  <b style="background: #FF5B85; color: white; padding: 3px 11px; border-radius: 4px; float: right; margin-bottom: 25px; margin-right: 36px;">Login Now</b></a>-->
        ...
        <div class="container">
            ...
            <div class="row mt-5">
                <div class="col-12 col-sm-6 col-lg-3 text-center mb-4 mb-lg-0">
                    <img src="<?php echo base_url() ?>assets/images/Trusted.png" draggable="false" alt="Trusted Matrimonial Service" width="auto" height="auto" class="readyIcon">
                    <h3>No.1 & Trusted</br>Matrimonial Service</h3>
                    <p>Our largest number of profiles<br>increases your chances.</p>
                </div>
                <div class="col-12 col-sm-6 col-lg-3 text-center mb-4 mb-lg-0">
                    <img src="<?php echo base_url() ?>assets/images/Charge.png" draggable="false" alt="No Charge for Registration" width="auto" height="auto" class="readyIcon">
                ...
                <div class="col-12 col-sm-6 col-lg-3 text-center mb-4 mb-sm-0">
                    <img src="<?php echo base_url() ?>assets/images/Validation.png" draggable="false" alt="Manual Screening and Validation" width="auto" height="auto" class="readyIcon">
                    <h3>Manual Screening</br>and Validation</h3>
                    <p>Our experts manually screen<br>and validate each profile.</p>
                </div>
                <div class="col-12 col-sm-6 col-lg-3 text-center">
                    <img src="<?php echo base_url() ?>assets/images/Security.png" draggable="false" alt="Best Data Security and Privacy" width="auto" height="auto" class="readyIcon">
                    ...
                    <div class="profCard">
                        <div class="d-flex justify-content-between mb-3">
                            <div class="pe-3">
                                <div class="name d-flex align-items-center">
                                    <img src="<?php echo base_url() ?>assets/images/name.png" alt="name" width="auto" height="auto" class="profileico">
                                    <span>Ayshakutty</span>
                                </div>
                                <div class="detls d-flex align-items-center">
                                    <img src="<?php echo base_url() ?>assets/images/physic.png" alt="name" width="auto" height="auto" class="profileico">
                                    <span>23 Yrs, 5' 0"</span>
                                </div>
                                <div class="detls d-flex align-items-center">
                                    <img src="<?php echo base_url() ?>assets/images/suitcase.png" alt="name" width="auto" height="auto" class="profileico">
                                    <span>Chief Program Liaison</span>
                        ...
                        <div class="col-12 col-md-7 col-xl-6">
                            ...
                            <div class="downico">
                                <a href="javascript:void(0)">
                                    <img style="height:50px;" src="<?php echo base_url() ?>assets/images/appleStore.png" draggable="false" alt="appleStore" width="auto" height="auto" class="storeIcon me-3">
                                </a>
                                <a target="_blank" href="https://play.google.com/store/apps/details?id=com.sysol.happy_nikah">
                                    <img style="height:50px;" src="<?php echo base_url() ?>assets/images/playStore.png" alt="playStore" draggable="false" width="auto" height="auto" class="storeIcon">
                                </a>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 d-flex align-items-center ms-auto">
                    <div class="w-100">
                        ...
                        <div class="d-flex align-items-center mb-4">
                            <div class="flex-shrink-0">
                                <img src="<?php echo base_url() ?>assets/images/telephone.png" draggable="false" alt="telephone" class="icon">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="<?php echo base_url() ?>assets/images/mail.png" draggable="false" alt="mail" class="icon">
                            </div>
                            <div class="flex-grow-1 ms-3">
    ...
    <!-- login Modal -->
    <div class="modal fade" id="loginModal" tabindex="-1" aria-labelledby="loginModalLabel" aria-hidden="true" <?php if ($_GET['error'] == 1) {
