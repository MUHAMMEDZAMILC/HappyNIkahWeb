...
and (max-width: 1605px)  
    ...
    background:transparent linear-gradient(114deg, #9de29f   0%, #94cc89 100%) 0% 0%    no-repeat padding-box;
...
.modal 
{
 ...
 <body>
    ...
    <section id="header" style="background-color: white;padding: 0px 0;position: fixed;top: 0;left: 0;right: 0;z-index: 11;box-shadow: 1px 5px #8e8c8c1c;">
        ...
        <nav class="navbar navbar-expand-lg">
            ...
            <div class="container">
                ...
                <a class="navbar-brand" href="<?php echo site_url('gotonikah_landing'); ?>">
         ...
         <img src="https://happynikah.com/happyadmin/assets/images/goto nikah logo.png" alt="Go to Nikah" class="gotoNikahlogo" style="width:150px !important;" height="auto">
                ...
                <div class="collapse navbar-collapse" id="navbarGoToNikah" style="margin-left:30px;">
    ...
    padding: 2px 0px;color: #ffff;">Login</button>
       ...
       <a href="https://wa.me/+918593999888" class="btn btn-success"  id="whatsapp55"   style="border-radius: 20px;width: 60px;float: right;
        ...
        <a href="tel:+918593999888" class="btn btn-primary mr-2" style="border-radius: 20px;width: 60px;float: right;text-decoration: none;
...
<!--                                           background-size: cover;background-position: inherit;position: static;margin-top: 65px;padding: 80px 0;">-->
        ...
        <div class="registration section-wrap"  style="background:transparent linear-gradient(0deg, #000000b8   0%, #6ab25c7d 100%) 0% 0%    no-repeat padding-box;
                                                       background-repeat: no-repeat;
                                                        background-size: cover;background-position: inherit;position: static;margin-top: 15px;padding: 80px 0;">  
        <div class="container"> 
            <div class="row align-items-center">
              ...
              <div class="col-lg-7">
                    ...
                    <div class="form-reg position-relative">
                        ...
                        <div class="content bg-white position-relative" id="homeback" style="margin-top:0px;">
                        ...
                        <!--style="border-right: 2px solid #ff5b85;padding-right: 15px;"-->
                            ...
                            <div class="w-100 register-heading-desk">
                                ...
                                <span class="hOne" style="color: #ffde21;font-size:40px;font-weight: 600;margin-bottom: 0px;">its free!</span><br/>
...
<h3 class="hTwo" align="center" style="margin-bottom: 2px;font-size: 16px;font-weight: 750;display:none;color: #5aba47;/* font-family: 'APPLE_CARDS_ABBAS'; */font-family: ;width: 85%;" noto="" sans="" malayalam",="" sans-serif;="" "="">
    ...
    <p id="email_val" class="validationclass"></p>
            ...
            class="btn cstmBtnColrs registernow" style="background-color: #000000;color:#fff;margin-left: -155px;margin-top: -9px;">
                Register Now</button>
...
<section id="homeDownload" style="background:transparent linear-gradient( 240deg , #68c36a59 0%, #aed4a670 100%) 0% 0% no-repeat padding-box;margin-bottom:15px;">
            ...
            <div class="modal-body p-0">
                <div class="row">
                    <div class="col-12 col-lg-6 d-none d-lg-flex align-items-stretch">
                        <div class="leftBox w-100" style="background: transparent linear-gradient( 209deg , #6fe872d1 0%, #a1df94db 100%) 0% 0% no-repeat padding-box;">
                    ...
                    <div class="col-12 col-lg-6 d-flex align-items-stretch" style="background: transparent linear-gradient(274deg,#ffff 0%, #ffff 100%) 0% 0% no-repeat padding-box;
                                                                                   background-size: contain;background-position: center center;">
                        <div class="rbox w-100">
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            <div class="d-flex justify-content-between mb-5">
                                <h3 class="welcomeHead">Welcome Back!<br><span style="color:#5ABA47;">Please Login</span></h3>
                            ...
                            <div class="emailLogBox">
                                <form class="customForm">
                                    ...
                                    <p class="note">By continuing, you agree to Goto nikah's <a href="<?php echo site_url('user/terms_gotonikah'); ?>">Terms of Use</a> and 
                                    <a href="<?php echo site_url('user/privacy_gotonikah'); ?>">Privacy Policy</a></p>
                                    <button type="button" class="btn cstmBtnColr w-100" id="loginbtn" onclick="login()" style="background-color:#5ABA47;">Login</button>
                                    <p class="orTxt">OR</p>
                                    <button type="button" class="btn w-100 mb-3 loginOtpBtn" style="color: #5ABA47;border: 1px solid #5ABA47;">OTP Login</button>
                                </form>
                            </div>
                            <div class="otpLogBox" style="display:none;">
                                ...
                                <p class="note">By continuing, you agree to Happy nikah's <a href="<?php echo site_url('user/terms_gotonikah'); ?>">Terms of Use</a>
                                and <a href="<?php echo site_url('user/privacy_gotonikah'); ?>">Privacy Policy</a></p>
                                <button type="button" class="btn cstmBtnColr sendOtp w-100" onclick="otplogin()" style="background-color: #5ABA47;">Send OTP</button>
                                <p class="orTxt">OR</p>
                                <button type="button" class="btn w-100 mb-3 loginEmailBtn" style="color: #5aba47;border: 1px solid #5aba47;"> Login with Id & Password</button>
                                </div>
                                </form>
                           ...
                           <!-- <div class="d-flex justify-content-between mb-3">
                            ...
                            <p class="text-center newtoTxt">New to GotoNikah <a href="<?php echo site_url('gotonikah_landing'); ?>">Register Now</a></p>
                        </div>
...
<div class="row">
            <div class="col-12 text-center">
                <p class="at">© 2023 Gotonikah All Rights Reserved</p>
            </div>
        </div>
            ...
            success: function(response) {
                ...
                if (response == 1) {
                    ...
                    setTimeout(function() {
                        ...
                        window.location.href = "<?php echo base_url(); ?>user/congratulations_gotonikah";
