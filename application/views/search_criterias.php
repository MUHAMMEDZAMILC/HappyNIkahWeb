        ...
        <div class="container">
            ...
            <div class="tab-content searchTabContent">
                ...
                <div class="tab-pane fade show active" id="searchProfile" role="tabpanel" aria-labelledby="searchProfile-tab">
                    ...
                    <form class="customForm"  action="<?php echo site_url('search_profile_common'); ?>" method="post" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-lg-4 mb-4 px-4">
                                ...
                                <label for="hightSlider-1" class="form-label">Hight</label>
                ...
                <div class="tab-pane fade" id="advancedSearch" role="tabpanel" aria-labelledby="advancedSearch-tab">
                    ...
                    <form class="customForm" action="<?php echo site_url('search_profile_advanced'); ?>" method="post" autocomplete="off">
...
-->                                </select>
                    ...
                    <?php } ?>  
                            ...
                            <button class="btn searchBtn" type="submit" style="color: #fff;font-size: 14px;font-family: "Roboto", sans-serif;background: #ff5b85;border-radius: 5px;width: 100%;margin-top: 32px;" >
                ...
                <div class="tab-pane fade" id="idSearch" role="tabpanel" aria-labelledby="idSearch-tab">
                    ...
                    <form class="customForm searchByIdOnly" action="<?php echo site_url('search_profile_id'); ?>" method="post" autocomplete="off">
