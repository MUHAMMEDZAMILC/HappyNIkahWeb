...
<div class="registration section-wrap" style="background: url('<?php echo base_url('assets/images/banner.png'); ?>');background-repeat: no-repeat;background-size: cover;background-position: center;position: relative;margin-top: 65px;padding: 80px 0;">
            ...
            കിടയില്&zwj; സ്നേഹവും കാരുണ്യവും ഉണ്ടാക്കുകയും ചെയ്തതും അവന്റെ ദൃഷ്ടാന്തങ്ങളില്&zwj; പെട്ടതത്രെ. തീര്&zwj;ച്ചയായും അതില്&zwj; ചിന്തിക്കുന്ന ജനങ്ങള്&zwj;ക്ക് ദൃഷ്ടാന്തങ്ങളുണ്ട് <br><span class="verse-number"> (വിശുദ്ധ ഖുര്&zwj;ആന്&zwj; 30:21)</span></p>
    ...
    <input type="text" class="form-control" id="name"   name="name" onkeypress="if (!window.__cfRLUnblockHandlers) return false; return lettersOnly(event)" placeholder="Bride / Groom Name *" 
    style="display: block;width: 90%;padding: 0.375rem 0.75rem;font-size: 1rem;font-weight: 400;border-radius: 10px !important;line-height: 1.5;color: #212529;background-color: #fff;
    background-clip: padding-box;border: 1px solid #ced4da;-webkit-appearance: none;-moz-appearance: none;appearance: none;border-radius: 0.25rem;transition: border-color 0.15s ease-in-out, box-shadow 0.15s ease-in-out;margin-bottom: 0px;
    margin-top: 20px;">
    ...
    <p style="margin-left: 20px;margin-top: -17px;" id="phone_val" class="validationclass"></p>
        ...
        <p id="email_val" class="validationclass"></p>
            ...
            <button type="button" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; checkvalidation()" class="btn cstmBtnColrs registernow">Register Now</button>
