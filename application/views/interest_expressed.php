            ...
            <div class="row">
                <div class="col-12 col-md-5 col-lg-4">
                    ...
                    <div class="appAdvBox2">
                        ...
                        <img src="<?php echo base_url() ?>assets/images/appMob.png" class="mobAppIcon">
                        <div class="row">
                    ...
                    <div class="profileListBox">
                        <div class="row">
                            <div class="col-12 d-flex align-items-center mb-4">
                                <h5 class="listTypeHead">Interest Expressed <span></span><?php echo count($InterestExpressed); ?></h5>
                            </div>
                        </div>
                        <div class="row">
                        <?php 
                         ...
                         <?php } 
                            ...
                            foreach ($InterestExpressed as $key) { ?>
