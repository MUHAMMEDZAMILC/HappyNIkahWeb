<!DOCTYPE html>
<html>
<?php include('include/downloadheader.php'); ?>
   ...
   <style>
    ...
    { 
        ...
        #appFeatures .fContentBox p
        {
           margin-right: 20px;    
        }
    #downloadSearch .appIcon 
    {
    /*width: 180%;*/
    /*margin-left: -111px;*/
                    ...
                    <div class="row">
                        <div class="col-12 col-md-12 col-xl-6 d-flex align-items-center">
                            <div class="w-100">
                                ...
                                <div class="d-flex">
                                    <!-- <a href="https://apps.apple.com/in/app/happy-nikah/id1638696026" data-bs-toggle="modal" data-bs-target="#exampleModalCenter55"> -->
                        ...
                        <div class="col-12 col-md-12 col-xl-6  d-flex align-items-center justify-content-center">
                            
                             <a href="https://apps.apple.com/in/app/happy-nikah/id1638696026">
                            <!-- <div class="appCircle"> -->

                                <img src="<?php echo base_url();?>assets/images/appMob1.png" alt="AppStore" width="auto" height="auto" class="appIcon">
                            <!-- </div> -->
                        </a>
                ...
                <div class="col-12 col-xxl-10 mx-auto">
                    <div class="row">
                        <div class="col-12 col-md-10 col-lg-8 mx-auto text-center">
                            ...
                            <p class="para1 mb-5" align="justify" style="margin-top:30px;"><i style="padding-bottom: 1px;" class="fa-solid fa-quote-left "></i>
                                If you are urgently looking for a life partner, you can start using the <a href="<?php echo base_url();?>about"> Happy Nikah Matrimony </a> 
                                app as soon as possible for free. To experience the features of Happy Nikah, Muslim marriage agency's app get it on the Google Play store and App store. 
                                It is the latest and most trustworthy marriage agency to help Muslim bachelors find their spouses. You can enjoy this matrimony app with the uninterrupted features.
                                If you are a Malayalee and you want to search for a partner through the Happy Nikah Muslim marriage agency you can download this matrimonial app and 
                                start using it from anywhere in the world. Enjoy finding your pair with the best and easy-to-use interface.
                                <i class="fa-solid fa-quote-right"></i></p>
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-12 col-lg-4 col-md-12 text-center mb-4 mb-md-0 h-103">
                        ...
                        <div class="col-12 col-lg-4 col-md-12 text-center mb-4 mb-md-0">
                            <div class="appFBox">
                                <div class="diamond">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="appFIcons" viewBox="0 0 16 16">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-xxl-10 mx-auto">
                    ...
                    <div class="row mt-5">
                        <div class="col-12 col-md-12 col-lg-5 d-flex align-items-center justify-content-center mb-4 mb-md-0">
                            <img src="<?php echo base_url();?>assets/images/1507.png" class="appScreen1" alt="app screen">
                        </div>
                        <div class="col-12 col-md-12 col-lg-7 d-flex align-items-center mb-4 mb-md-0">
                            <div class="w-100">
                                <div class="fBox d-flex" id="fbox1">
                                    <div class="fIconBox">
                                        <img src="<?php echo base_url();?>assets/images/handshake.svg" alt="">
                                    </div>
                                    <div class="fContentBox">
                                        <h3>User Friendly</h3>
                                        <p  class="description">We have our own unique app interface that makes our apps more comfortable for the users. 
                                        From registration to matchmaking, we consider each step to create this unique interface.</p>
                                    </div>
                                </div>
                                <div class="fBox d-flex">
                                    ...
                                    <div class="fContentBox">
                                        ...
                                        <p  class="description">Registering with this matrimonial app is very simple. You only need to update your primary facts like name, gender, age, e-mail address, and phone number to start with. Filling in mandatory fields helps to get the best matching profiles</p>
                                    </div>
                                </div>
                                <div class="fBox d-flex">
                                    <div class="fIconBox">
                                    ...
                                    <div class="fContentBox">
                                        <h3>100 % Secured </h3>
                                        <p  class="description">We assure 100 % data security to our users. The complete information that you have shared with us is always secure and safe. We don’t share your information with anyone without your permission.</p>
                                    </div>
                                </div>
                                <div class="fBox d-flex">
                                    <div class="fIconBox">
                                    ...
                                    <div class="fContentBox">
                                        ...
                                        <p  class="description">We are more concerned about each and every registration of our matrimony. Only verified profiles are allowed to be listed on our matrimony and we have a dedicated team to review each profile manually</p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <!--                                    <p class="note">By continuing, you agree to HappyNikah's -->
    <!--                                    <a href="<?php echo site_url();?>terms">Terms of Use</a> and -->
                                        
    <!--                                    <a href="<?php echo site_url();?>privacy">Privacy Policy</a></p>-->
    ...
    <!--                                    </div>-->
    <!--                                    <p class="note">By continuing, you agree to Gotonikkah's <a href="<?php echo site_url();?>terms">-->
    <!--                                  Terms of Use</a>-->
    <!--                                    and -->
    <!--                                    <a href="<?php echo site_url();?>privacy">Privacy Policy</a></p>-->
    ...
    <!--                                </a>-->
    <!--                            </div>-->
    <!--                            <p class="text-center newtoTxt">New to Happy Nikah <a href="<?php echo base_url();?>">Register Now</a></p>-->
    <!--                        </div>-->
