...
<?php include('include/user_header_gotonikah.php'); ?>
                    ...
                    <div class="helpSupport mb-4">
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-6 mb-3">
                                <p>if you need any help from Goto Nikah Customer side, Please reach our customer care executive</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12 col-xl-8">
                                ...
                                <div class="row mb-5 mb-xl-4">
                                    <div class="col-12 col-lg-5 mb-3 mb-lg-0 d-flex align-items-center">
                                        <div class="d-flex align-items-center">
                                            <img src="<?php echo base_url() ?>assets/images/mail_new.jpg" class="helpTypeIcon">
                            ...
                            <div class="col-12 col-xl-4">
                                ...
                                <a href="<?php echo base_url();?>user/upgradeto_premium_gotonikah">
  ...
  <style>
      #userContent .helpSupport .linkBtn {
    color: #fff;
...
#userContent .helpSupport .chatPaymentSupportBtn {
    background: #cdf7c4;
    border-radius: 5px;
    color: #2b3841;
    font-size: 14px;
                    ...
                    <form class="customForm">
                        <div class="mb-3">
                            <select class="form-select" aria-label="Default select example">
                              ...
                              <option value="1">I found my match on Goto Nikah</option>
                              <option value="2">I found my match on other sites</option>
                              <option value="3">Taking a break</option>
                              <option value="4">I am unhappy with my experience on Goto Nikah</option>
