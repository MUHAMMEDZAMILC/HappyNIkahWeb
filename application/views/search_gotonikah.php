...
<span   onclick="ignore_profile('<?php echo $key->id; ?>')"><img src="<?php echo base_url();?>assets/images/Ignore.svg" class="icon">Ignored</span></a>
                    ...
                    <div class="appAdvBox" style="background: transparent linear-gradient(91deg, #6fc95ea3 0%, #5aba47 100%) 0% 0% no-repeat padding-box;padding: 50px 70px 0;">
                        <div class="row">
                            <div class="col-12 col-xl-6">
                                <h2 class="subHead mb-4">Search Profiles<br><span tyle="color:#fff;">Anytime! Anywhere!!</span></h2>
