<!DOCTYPE html>
<html>
<?php include('include/downloadheader_gotonikah.php'); ?>
   ...
   #appFeatures .fContentBox p
   {
    ...
    {
    background: #ffffff;
    box-shadow: 0px 10px 25px #5ABA47;
    }
    
    #aboutApp .appFBox:hover .diamond::before 
    {
    background-color: #5ABA47;
   }
   #aboutApp .appFBox .appFIcons
   {
       fill:#5ABA47;
   }
   #aboutApp .appFBox:hover h3
   {
      color:#5ABA47; 
   }
   ...
   #appFeatures
   {
    background: transparent linear-gradient(90deg, #1B3F1C 0%, #5ABA47 100%) 0% 0% no-repeat padding-box;
   }
    </style>
            ...
            <section id="downloadSearch" style="background: transparent linear-gradient(90deg,#1B3F1C 0%, #5ABA47 100%) 0% 0% no-repeat padding-box;">
            ...
            <div class="appCircle">
            <img src="<?php echo base_url();?>assets/images/Mobile_single.png"  style="height:444px !important;width:110% !important;margin-left: -80px;" alt="playStore" width="auto" height="auto" class="appIcon">
            </div>
            </div>
            </div>
            </div>
            ...
            <h2 class="subHead" style="margin-bottom: 50px;">The Perfect Matchmaking App</h2>
            <p class="para1 mb-5" align="justify"><i style="padding-bottom: 1px;" class="fa-solid fa-quote-left "></i>
            If you are urgently looking for a life partner, you can start using the <a href="<?php echo site_url('user/about_gotonikah'); ?>"> Goto Nikah Matrimony </a>
            app as soon as possible for free.To experience the features of Goto Nikah, Muslim marriage agency's app get it on the Google Play store and App store. 
            ...
            If you are a Malayalee and you want to search for a partner through the Goto Nikah Muslim marriage agency you can download this matrimonial app and start using it from anywhere in the world. 
            Enjoy finding your pair with the best and easy-to-use interface.
            ...
            <img src="<?php echo base_url();?>assets/images/Go to nikah png.png" class="appScreen1" alt="app screen">
            </div>
            ...
            <h3>User Friendly</h3>
            <p>We have our own unique app interface that makes our apps more comfortable for the users. 
            ...
            <p>Registering with this matrimonial app is very simple. You only need to update your primary facts like name, gender, age,
            e-mail address, and phone number to start with. Filling in mandatory fields helps to get the best matching profiles.</p>
            </div>
            </div>
            <div class="fBox d-flex">
            <div class="fIconBox">
            ...
            <div class="fContentBox">
            <h3>100 % Secured </h3>
            <p>We assure 100 % data security to our users. The complete information that you have shared with us is always secure and safe. 
            We don’t share your information with anyone without your permission.</p>
            </div>
            </div>
            <div class="fBox d-flex">
            <div class="fIconBox">
            ...
            <p>We are more concerned about each and every registration of our matrimony. Only verified profiles are allowed to be listed on our 
            matrimony and we have a dedicated team to review each profile manually.</p>
            </div>
            </div>
            </div>
            </div>
                ...
                <section id="talkUser">
                <img src="<?php echo base_url();?>assets/images/wave_goto.png" class="w-100">
                <!-- <div class="container">
                <div class="row">
