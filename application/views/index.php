...
fbq('init', '827599408752075');
fbq('track', 'PageView');
</script>
<noscript>
<img height="1" width="1" style="display:none"
src="https://www.facebook.com/tr?id=827599408752075&ev=PageView&noscript=1"
/>
</noscript>
<!-- End Meta Pixel Code -->
                ...
                <div class="collapse navbar-collapse" id="navbarGoToNikah">
                    ...
                    <ul class="navbar-nav mx-auto mb-2 mb-lg-0 mt-3 mt-lg-0">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="<?php echo site_url('contactus'); ?>">Contact</a>
...
<div class="registration section-wrap" style="background: url('<?php echo base_url('assets/images/banner.png'); ?>');background-repeat: no-repeat;background-size: cover;background-position: center;position: relative;margin-top: 65px;padding: 80px 0;">
            ...
            style="font-weight: 700;background: #d2cacab5;padding: 15px 4px;color: #362a2a;font-size: 92%;position: relative;z-index: 1;/* font-family: 'APPLE_CARDS_ABBAS'; */font-family: "Noto Sans Malayalam", sans-serif;">

           <!--  നിങ്ങള്&zwj;ക്ക് സമാധാനപൂര്&zwj;വ്വം ഒത്തുചേരേണ്ടതിനായി നിങ്ങളില്&zwj; നിന്ന് തന്നെ നിങ്ങള്&zwj;ക്ക് ഇണകളെ സൃഷ്ടിക്കുകയും, നിങ്ങള്&zwj;ക്

            കിടയില്&zwj; സ്നേഹവും കാരുണ്യവും ഉണ്ടാക്കുകയും ചെയ്തതും അവന്റെ ദൃഷ്ടാന്തങ്ങളില്&zwj; പെട്ടതത്രെ. തീര്&zwj;ച്ചയായും അതില്&zwj; ചിന്തിക്കുന്ന ജനങ്ങള്&zwj;ക്ക് ദൃഷ്ടാന്തങ്ങളുണ്ട് <br><span class="verse-number"> (വിശുദ്ധ ഖുര്&zwj;ആന്&zwj; 30:21)</span> -->
     ...
     <br><span class="verse-number"> (വിശുദ്ധ ഖുര്&zwj;ആന്&zwj; 30:21)</span>
        </p>
              ...
              <div class="col-lg-7">
                    ...
                    <div class="form-reg position-relative" style="margin-top:-40px;">
                        ...
                        <div class="content bg-white position-relative" id="homeback">
                        ...
                        <!--style="border-right: 2px solid #ff5b85;padding-right: 15px;"-->
                            ...
                            <div class="w-100 register-heading-desk">
                                ...
                                <h2 class="pOne" style="color: #fff;font-size:25px;">Register Now </h2>



                                <span class="hOne" style="color: #f5d310;font-size:40px;font-weight: 600;margin-bottom: 0px;">its free!</span>
                       ...
                       <h3 class="hTwo" align="center" style="margin-bottom: 2px;font-size: 16px;font-weight: 750;color: #ffffff;/* font-family: 'APPLE_CARDS_ABBAS'; 

                       */font-family: ;width: 85%;" noto="" sans="" malayalam",="" sans-serif;="" "="">സന്തോഷകരമായ ജീവിതത്തിനു അനുയോജ്യമായ പങ്കാളിയെ കണ്ടെത്തൂ......</h3>
    ...
    placeholder="Bride / Groom Name *" style="display: block;width: 90%;padding: 0.375rem 0.75rem;font-size: 1rem;font-weight: 400;border-radius: 10px !important;line-height: 1.5;color: #212529;background-color: #fff;background-clip: padding-box;border: 1px solid #ced4da;-webkit-appearance: none;-moz-appearance: none;appearance: none;border-radius: 0.25rem;transition: border-color 0.15s ease-in-out, box-shadow 0.15s ease-in-out;margin-bottom: 0px;margin-top: 20px;" required>
   ...
   <input style="width: 90%;border-radius: 10px;" type="text" class="cusform-control" placeholder="Phone Number" id="phone" name="phone" maxlength="10" onkeypress="return event.charCode >= 48 && event.charCode <= 57;">
    ...
    <p style="margin-left: 20px;margin-top: -17px;" id="phone_val" class="validationclass"></p>
        ...
        <p id="email_val" class="validationclass"></p>
            ...
            <label class="form-check-label" for="flexCheckDefault" id="chk" style="COLOR: #020202;">I have read and agree to the 

            

            <a href="<?php echo site_url('terms'); ?>" 

            data-bs-toggle="modal" data-bs-target="#termsModal">Terms and Condition</a></label>
            ...
            <button type="button" onclick="checkvalidation()" class="btn cstmBtnColrs registernow">Register Now</button>
    ...
    <div class="container">
        ...
        <h2 class="subHead" style="margin-top: 30px;"><svg style="margin-bottom: 45px;color:#FF5B85;" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-hearts" viewBox="0 0 16 16">
        ...
        <a href="<?php echo base_url();?>about"> Muslim marriage bureau </a> is free; once completed, the team behind this Muslim community matrimony will screen the profile to validate and confirm its authenticity. After the completion of registration on this marriage bureau, the members can contact each other.

        

        The user interface of this nikah matrimonial Happy Nikah, is very easy to use and simple. This <a href="<?php echo base_url();?>about"> matchmaking website </a> provides a free search facility to every Malayalee Muslim bachelor out there. Unlike all other matrimony websites, this Muslim marriage bureau in Kerala will promise you that they are highly committed to the culture and creed of the Islamic religion.
        ...
        <img src="<?php echo base_url('/assets/photo_storage/' . $vals->photo); ?>"  id="slide_image"  alt="profile image" class="proImg" style="height:100%;">
        ...
        <button class="btn connectBtn"  data-bs-toggle="modal" data-bs-target="#loginModal">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-12 d-flex align-items-center mb-5 mb-md-0">
                ...
                <div class="w-100">
                    ...
                    <h2 class="subHead" style="margin-top:0px;">Begin your <span>journey with us.</span></h2>
                    ...
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <p class="addText mb-0" id="txt">IV th Floor, Neospace,Kinfra Techno Industrial Park,<br> 
                    ...
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <p class="mobText mb-0" id="mob">+91-8593999888</p>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <p class="addText mb-0" id="mail_happy">info@happynikah.com</p>
...
<script type="text/javascript">
...

   {
    ...
    //      window.location = "intent://happynikah.com#intent;scheme=http;package=com.sysol.happy_nikah;end";
    ...
    //     }
        ...
        // window.location = "https://play.google.com/store/apps/details?id=com.sysol.happy_nikah";
    ...
    const imgElement = document.getElementById('slide_image');

    const imageUrl = 'https://happynikah.com/assets/photo_storage/<?php echo $vals->photo; ?>';
...

    {
        ...
        imgElement.src = '../../../../assets/photo_storage/<?php echo $vals->photo; ?>';
