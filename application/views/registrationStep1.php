                ...
                <div class="col-12">
                    <div id="ERtabV" class="resp-vtabs hor_1">
                        <ul class="resp-tabs-list hor_1">
                            <li class="resp-tab-item hor_1 resp-tab-active" onclick="window.location.href='<?php echo site_url('registration_step1?currentpage=1'); ?>'">
                            ...
                            <div class="resp-tab-content hor_1 resp-tab-content-active">
                                <div class="row">
                                    <div class="col-12 col-lg-10 mx-auto">
                                        <form action="<?php echo site_url('user/register_basicinfo'); ?>?currentpage=1" method="post" autocomplete="off" class="customForm" id="bascidetails">
...
<script  type="text/javascript">
    ...
    minDate: '1985-01-01',
    maxDate: '2010-12-31',
    yearRange: '1985:c', // Specify the year range from 1985 to the current year (denoted by 'c')
    onSelect: function(value, ui) {
        var today = new Date();
        age = today.getFullYear() - ui.selectedYear;
        $('#age').val(age);
...
//     $('#dob').datepicker({
//     dateFormat: 'yy-mm-dd',
//     minDate: new Date('1985-01-01'), // Set minimum date to January 1st, 1985
//     maxDate: new Date('2010-12-31'), // Set maximum date to December 31st, 2010
//     onSelect: function(value, ui) {
//         var today = new Date();
//         age = today.getFullYear() - ui.selectedYear;
//         $('#age').val(age);
