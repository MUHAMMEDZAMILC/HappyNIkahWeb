                ...
                <div class="col-12">
                    <div id="ERtabV" class="resp-vtabs hor_1">
                        ...
                        <li class="resp-tab-item hor_1" onclick="window.location.href='<?php echo site_url('registration_step1?currentpage=1'); ?>'">
                            ...
                            <li class="resp-tab-item hor_1" onclick="window.location.href='<?php echo site_url('registration_steptwo?currentpage=1'); ?>'">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div class="circleNo">
                                            <span>2</span>
                            ...
                            <li class="resp-tab-item hor_1" onclick="window.location.href='<?php echo site_url('registration_stepthree?currentpage=1'); ?>'">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div class="circleNo">
                                            <span>3</span>
                            ...
                            <li class="resp-tab-item hor_1 resp-tab-active" onclick="window.location.href='<?php echo site_url('registration_stepfour?currentpage=1'); ?>'">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div class="circleNo">
                                            <span>4</span>
                        ...
                        <div class="resp-tabs-container hor_1">
                            ...
                            <div class="resp-tab-content hor_1 resp-tab-content-active">
                                <div class="row">
                                    ...
                                    <form action="<?php echo site_url('user/register_profiledescription'); ?>?currentpage=1" method="post" autocomplete="off" class="customForm" 
                                    enctype="multipart/form-data" id="profile">
                                            <div class="row">
                                                <div class="col-12 col-xl-4 mb-3">
                                                    ...
                                                    <img id="imgview" style="width: 100%;  margin-bottom: 10px;margin-top:10px;"  
                                                src="https://happynikah.azurewebsites.net/api/Files/photo_storage/?filePath=<?php echo $ProfileDetails->photo; ?>">
                                                ...
                                                <div class="col-12 col-xl-8">
                                                    ...
                                                    <div class="mb-3 pwBox d-none">
                                                        <input type="text" class="form-control" placeholder="Enter Password" name="photopassword" <?php if(isset($photo_settings->photopassword) &&  $photo_settings->photopassword!= '0'){ echo 'value="'.$photo_settings->photopassword.'"';}?>>
                                                        <div class="form-check mt-2 mb-1">
                                                            <input class="form-check-input" type="checkbox" value="1" id="show1" name="showtoexpress" <?php if(isset($photo_settings->showtoexpress) && $photo_settings->showtoexpress != '0'){ echo 'checked';}?>>
                                                            <label class="form-check-label" for="show1">Show my photo to express interest accepted member</label>
                                                        </div>
                                                        <div class="form-check mb-3">
                                                            <input class="form-check-input" type="checkbox" value="1" id="show2" name="showtopremium"<?php if(isset($photo_settings->showtopremium) &&  $photo_settings->showtoexpress!= '0'){ echo 'checked';}?>>
                                            ...
                                            <div class="row mb-4">
                                                <div class="col-12 mb-3">
                                                    ...
                                                    <textarea class="form-control" rows="3" name="about" placeholder=""><?php if(isset($ProfileDetails->about) &&  $ProfileDetails->about!= ''){ echo $ProfileDetails->about;} else{echo $uabout;}?> </textarea>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-12 col-md-6 mb-3 mb-md-0">
                                                    <button type="button" class="btn backBtn w-100" onclick="window.location.href='<?php echo site_url('registration_stepthree?gotoback=3'); ?>'">Back</button>
                                                </div>
