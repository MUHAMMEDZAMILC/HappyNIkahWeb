...
<br><br>
                        ...
                        <form class="customForm" action="<?php echo site_url('user/send_feedback_gotonikah'); ?>" method="post">
                    ...
                    <form class="customForm">
                        <div class="mb-3">
                            <select class="form-select" aria-label="Default select example">
                              ...
                              <option value="1">I found my match on Goto Nikkah</option>
                              <option value="2">I found my match on other sites</option>
                              <option value="3">Taking a break</option>
                              <option value="4">I am unhappy with my experience on Goto Nikkah</option>
