                   ...
                   <form>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-10" style="margin-left: 40px;">
                                ...
                                <input type="text" style="width:96%;" class="cusform-control" placeholder="Bride / Groom Name *" id="name" name="name" onkeypress="if (!window.__cfRLUnblockHandlers) return false; return lettersOnly(event)">
                       ...
                       <div class="col-12 col-md-10" style="margin-left: 39px;">
                        ...
                        <div class="row" style="margin-left: 26px;margin-top:20px;">

                            <div>

                                <select style="width: 107px;" name="countryCode" id="countryCode" class="cusform-control code-country" required="">
                            ...
                            <div class="col-lg-8 col-md-10">
                                ...
                                <input style="margin-left:114px;margin-top:-38px;" type="text" class="cusform-control" placeholder="Phone Number" id="phone" name="phone" maxlength="10" onkeypress="if (!window.__cfRLUnblockHandlers) return false; return event.charCode > 47 &amp;&amp; event.charCode < 58;">

                                <span id="countrycode_val" style="color: red;font-size: 12px;"></span>

<br>

                                <p style="margin-left:116px;margin-top:-22px;" id="phone_val" class="validationclass"></p>
                        ...
                        <div class="d-sm-flexs justify-content-between align-items-center">
                            ...
                            <div class="form-check mb-4 mb-sm-01">
                                ...
                                <label class="form-check-label" for="flexCheckDefault" id="chk">I have read and agree to the <a href="#" data-bs-toggle="modal" data-bs-target="#termsModal">Terms and Condition</a></label>
                        ...
                        <div class="regsub" style="margin-left:172px;">
                            ...
                            <button type="button" onclick="if (!window.__cfRLUnblockHandlers) return false; checkvalidation()" class="btn cstmBtnColrs registernow">Register Now</button>
