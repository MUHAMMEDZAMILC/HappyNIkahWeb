    ...
    <button class="btn sendBtn" type="button" onclick="send_usermessage()" style="background-color: #5aba47;">
    ...
    if(file_exists($file_pointer)){
    ?>
    <img src="'.base_url().'/assets/photo_storage/'.$photo.'" alt="profile image" class="proImg" style="height:100%;">
    ...
    ?>
    <img src="'.base_url().'/assets/photo_storage/'.$photo.'" alt="profile image">
    ...
    <a href="<?php echo site_url('user/singleprofile/'.$id); ?>">View Profile</a>
    </div>
    <div class="likeDislikeBox mb-0" id="likesdislikes">
    <?php if($page!=""){?>
    
    <div class="headBox" style="background:linear-gradient( 30deg, rgb(90 186 71) 0%, rgb(90 186 71 / 59%) 100% );">
    <div class="row">
    ...
    <img src="<?php echo base_url() ?>assets/images/Ignore_gotonikah.png" class="chk" >
    <?php } ?>                                </div>
    </div>
    <div class="row mb-2">
    <div class="col-5 d-flex align-items-center">
    ...
    <div class="col-12 col-md-7 col-lg-5 mb-4 mb-lg-0">
    <a href="<?php echo base_url();?>user/upgradeto_premium_gotonikah"> <p style="text-align:center">To avail the chat facility you must be a premium member. For Support, Please Reach our customer care.<br>Customer care : +918593999888</p><br><button class="btn addrSubBtn col-md-12" style="background-color:#5aba47;">Upgrade to Premium</button></a>
    </div>
    ...
    <div class="col-12 col-md-7 col-lg-5 mb-4 mb-lg-0">
    <a href="<?php echo base_url();?>user/upgradeto_premium_gotonikah"> <p style="text-align:center">You have reached your limit.For Support, Please Reach our customer care.<br>Customer care : +918593999888</p><br><button class="btn addrSubBtn col-md-12" style="background-color:#5aba47;">Upgrade to Premium</button></a>
    </div>
    <div class="col-12 col-lg-4"></div></div>
    <?php
    }?>
   ...
   <style>
    ...
    button.btn.addrSubBtn.col-md-12 
    {
    color: #fff;
    }
  </style> 
