...
<?php include('include/header.php'); ?>
                    ...
                    <div class="profileListBox">
                        <div class="row">
                            <div class="col-12 d-flex align-items-center mb-4">
                                <h5 class="listTypeHead">Suggested Profiles <span></span><?php echo $MatchingProfilesCount ?></h5>
                            </div>
                        </div>
                        <div class="row">
                            <?php 
                            ...
                            foreach ($MatchingProfiles as $key) { ?>
                                ...
                                <div class="proLstBox">
                                   <a href="<?php echo site_url('user/singleprofile/'.$key->id); ?>">
                                            ...
                                            if($key->gender== 1){ ?>
                                                <img src="<?php echo base_url('/assets/photo_storage/male.jpeg'); ?>" alt="profile image" class="proImg" style="height:100%;">
                                            <?php }
                                            else if($key->gender== 2){ ?>
                                                <img src="<?php echo base_url('/assets/photo_storage/female.jpeg'); ?>" alt="profile image" class="proImg" style="height:100%;">
                                            <?php }
                                     } 
                                     else{ 
                                     ...
                                     <?php }
                                         ...
                                         <?php } //end of not requested for photo
    ...
    <?php }
        ...
        if($key->gender== 1){ ?>
               ...
               <img src="<?php echo base_url('/assets/photo_storage/male.jpeg'); ?>" alt="profile image" class="proImg">
               <div class="lockOverlay">
                                                                        <img src="<?php echo base_url();?>assets/images/lockProfile.svg">
                                                                    </div>
           <?php }
               ...
               <img src="<?php echo base_url('/assets/photo_storage/female.jpeg'); ?>" alt="profile image" class="proImg">
               <div class="lockOverlay">
                                                                        <img src="<?php echo base_url();?>assets/images/lockProfile.svg">
                                                                    </div>
           <?php }
                        ...
                        <!-- <div class="d-lg-flex justify-content-end">
                            <div class="paginationPBox d-lg-flex align-items-center mb-5">
                                <span class="resCount mb-4 mb-lg-0">Results: 10 - 17 of 128</span>
                                <nav data-pagination class="navPagntn me-3 mb-4 mb-lg-0">
                                  <a href=# disabled><img src="<?php echo base_url() ?>assets/images/chevron-l.png"></a>
                                  <ul>
                                  ...
                                  <a href=#2><img src="<?php echo base_url() ?>assets/images/chevron-r.png"></a>
                                </nav>
                                <select class="form-select itmPerPageSlct" aria-label="Default select example">
