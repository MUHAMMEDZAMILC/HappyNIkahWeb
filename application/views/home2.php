...
<body>
    ...
    <section id="banner">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-5 col-md-12 d ">
                    <!-- replace quraan words -->
                    <div class="regBox"
                    <p>
                    <h1 style="color:#f2135a;" class=""><b>THE EXCLUSIVE<br>MUSLIM<br>MATRIMONY</b></h1><br></p>
                    <ul>
                        <li type="disc" style="font-size: 30px;">
                            <h4><b>100% verified profiles</b></h4>
                        </li>
                        <li type="disc" style="font-size: 30px;">
                            <h4><b>NRI Profiles</b></h4>
                        </li>
                        <li type="disc" style="font-size: 30px;">
                            <h4><b>Safe & Secured</b></h4>
                        </li>
                    </ul>
                </div>
                ...
                <div class="col-12 col-lg-7 col-md-12 d-flex align-items-center">
                    <div class="regBox">
                        ...
                        <!--<form action="<?php //echo site_url('user/register'); 
                                            ?>" method="post" autocomplete="off" class="customForm">-->
                       
                       
                       
                       
                        <form action="https://www.waytonikah.com/UserAuthentication/registertype" method="post" class="col-12" onsubmit="if (!window.__cfRLUnblockHandlers) return false; return ValidationBasic();">
    <div class="row">
  ...
  <div class="form-control" style="width: 87%;margin-left: 11px;" id="gender_field">
    ...
    <img style="margin-left: 74px;margin-top: -42px;" src="https://happynikah.com/assets/images/male.svg" id="ml" alt="male" width="24px" height="24px">
    ...
    <div class="vl" style="border-left: 0px solid transparent;height: 34px;margin-left: 127px;margin-top: -76px;"></div>
    
    
    <input class="form-check-input" type="radio" name="gender" id="female" value="2" style="margin-left: 161px;margin-top: 6px;">
    
    <label class="form-check-label" for="female" style="/* margin-top: -162px !important; */margin-left: 186px;" id="fml">Female</label>
    
    <img style="margin-left: 240px;margin-top: -48px;" src="https://happynikah.com/assets/images/female.svg" id="fl" alt="male" width="24px" height="24px">
    
    <!--<span style="border-left: 2px solid #ff5b85;height: 24px;margin-left:10px;padding-top: 35px;padding-bottom:12px;"></span>-->
    
    <div class="v2" style="border-left: 2px solid #ff5b85;height: 36px;margin-left: 292px;margin-top: -50px;">
    ...
    <img style="margin-left: 5px; color:#0892FD;" src="https://happynikah.com/assets/images/calendar.svg" alt="calendar" width="24px" height="24px;">
    ...
    <div class="row" style="margin-left: -14px;margin-top:20px;" id="ctphone">
    
    <div class="col-lg-4 col-4">
    
    <select style="width: 85%;" name="countryCode" id="countryCode" class="cusform-control code-country" required="">
    ...
    <input style="width: 85%;" type="text" class="cusform-control" placeholder="Phone Number" id="phone" name="phone" maxlength="10" onkeypress="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; return event.charCode > 47 &amp;&amp; event.charCode < 58;">
    ...
    <p style="margin-left: 20px;margin-top: -17px;" id="phone_val" class="validationclass"></p>
      ...
      <?php $country= $this->db->select('*')->from('tbl_country')->get()->result_array();?>
        ...
        <select id="state" class="form-control form-select" name="state"  style="width:90%;" required>
...
<label class="form-check-label" for="flexCheckDefault" id="chk" style="
    COLOR: #020202;
