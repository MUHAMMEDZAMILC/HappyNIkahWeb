                ...
                <div class="col-12">
                    <div id="ERtabV" class="resp-vtabs hor_1">
                        <ul class="resp-tabs-list hor_1">
                            ...
                            <li class="resp-tab-item hor_1 resp-tab-active" onclick="window.location.href='<?php echo site_url('registration_stepthree?currentpage=1'); ?>'">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div class="circleNo">
                                            <span>3</span>
                        ...
                        <div class="resp-tabs-container hor_1">
                            ...
                            <h2 class="resp-accordion hor_1 resp-tab-active"  onclick="window.location.href='<?php echo site_url('registration_steptwo?currentpage=1'); ?>'">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div class="circleNo">
                                            <span>3</span>
                  ...
                  <?php } ?>
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-md-6 mb-3 mb-md-0">
                                                    <button type="button" class="btn backBtn w-100" onclick="window.location.href='<?php echo site_url('registration_steptwo?gotoback=2'); ?>'">Back</button>
                                                </div>
