                ...
                <div class="col-12">
                    <div id="ERtabV" class="resp-vtabs hor_1">
                        <ul class="resp-tabs-list hor_1">
                            <li class="resp-tab-item hor_1 resp-tab-active" onclick="window.location.href='<?php echo site_url('user/registration_step1?currentpage=1'); ?>'">
                  ...
                  <option value="Normal"  <?= (isset($BasicDetails->physical_status) && !empty($BasicDetails->physical_status)) ? ($BasicDetails->physical_status == 'Normal' ? 'selected' : '') : '' ?>>Normal</option>
                    ...
                    <?php } ?>
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-md-6 mb-3">
                                                    <label class="form-label">Religeon</label>
