<? $photo_status = $this->General_Model->check_photorequest($this->session->userdata('user_id'));
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 mb-4 mb-sm-0 d-none d-lg-flex align-items-center justify-content-center justify-content-sm-start">
                        ...
                        <a class="" href="<?php echo site_url('user/gotonikah'); ?>">
        ...
        <nav class="navbar navbar-expand-lg">
            ...
            <div class="container">
                ...
                <span class="line"></span>
                    ...
                    <a class="nav-link active" aria-current="page" href="<?php echo site_url('user/home_gotonikah'); ?>">Home</a>
                    ...
                    <a class="nav-link" href="<?php echo site_url('user/upgradeto_premium_gotonikah'); ?>">Upgrade To Premium</a>
                    
                    </li>
                    
                    <li class="nav-item">
                    
                    <a class="nav-link" href="<?php echo site_url('user/help_support_gotonikah'); ?>">Help</a>
            ...
            <a href="#" aria-label="Delete" onclick="delete_notification(<?php echo $vals->nid;?>)" >
                ...
                <div style="float:right;"><a  href="<?php echo base_url();?>user/view_allnotifications2_gotonikah" onclick="view_allnotifications2_gotonikah(<?php echo $this->session->userdata('user_id');?>)">View All</a></div>
                ...
                <a href="<?php echo site_url('user/user_chat_gotonikah'); ?>" class="chatBox" >
                ...
                <a class="dropdown-item" href="<?php echo site_url('user/profile_gotonikah') ?>">
                ...
                <a class="dropdown-item" href="<?php echo site_url('user/change_password_gotonikah') ?>">
                ...
                function view_allnotifications2_gotonikah(receiver_id)
                
                {
                
                $.ajax({
                
                url: "<?php echo site_url('user/view_allnotifications2_gotonikah'); ?>",
