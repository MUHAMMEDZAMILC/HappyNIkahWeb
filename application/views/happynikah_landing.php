...
.modal 
{
 ...
 <body>
    ...
    <section id="header" style="background-color: #ff5b85;padding: 0px 0;position: fixed;top: 0;left: 0;right: 0;z-index: 11;box-shadow: 1px 5px #8e8c8c1c;">
        ...
        <nav class="navbar navbar-expand-lg">
            ...
            <div class="container">
                   ...
                   <a class="navbar-brand" href="<?php echo site_url('landing'); ?>">
                    ...
                    <img src="<?php echo base_url() ?>assets/images/HappyNikkahwhite.png" alt="Happy Nikah" width="auto" style="width: 80px;" height="auto" class="gotoNikahlogo">
                 ...
                 <div class="mob-login" id="moblogin">
                    ...
                    style="background: #ffffff;color: #000;">Login</button>
                ...
                <div class="collapse navbar-collapse" id="navbarGoToNikah">
                    ...
                    <a href="https://apps.apple.com/in/app/happy-nikah/id1638696026" style="margin-top: -84px;" id="headicon">
    ...
    margin-bottom: -23px;" class="storeIcon me-3">
                    ...
                    <div class="web-login">
                        ...
                        <button type="button" class="btn loginbtn" data-bs-toggle="modal" data-bs-target="#loginModal" style="background: ##ffffff;width: 90px;margin-left: 8px;
    padding: 2px 0px;color: #000;">Login</button>
...
<!--<div class="registration section-wrap"   style="background: url(https://happynikah.com/assets/images/Go2Nikahhome.jpg);-->
<!--                                           background-repeat: no-repeat;-->
<!--                                           background-size: cover;background-position: inherit;position: static;margin-top: 65px;padding: 80px 0;">-->
        
        <div class="registration section-wrap"  style="background:#e3e3e3c4;
                                                       background-repeat: no-repeat;
                                                        background-size: cover;background-position: inherit;position: static;margin-top: 65px;padding: 80px 0;">  
        <div class="container"> 
            <div class="row align-items-center">
                <div class="col-lg-5 text-center">
                   ...
                   <!--  <div class="top-head w-100 text-center">
                    ...
                    <img src="<?php echo base_url();?>assets/images/Capture11.PNG"     style="width: 100%;height: auto;">
              ...
              position: relative;z-index: 1;/* font-family: 'APPLE_CARDS_ABBAS'; */font-family: "Noto Sans Malayalam", sans-serif;">
                        നിങ്ങള്&zwj;ക്ക് സമാധാനപൂര്&zwj;വ്വം ഒത്തുചേരേണ്ടതിനായി നിങ്ങളില്&zwj; നിന്ന് തന്നെ നിങ്ങള്&zwj;ക്ക് ഇണകളെ സൃഷ്ടിക്കുകയും, നിങ്ങള്&zwj;ക്കിടയില്&zwj; സ്നേഹവും കാരുണ്യവും ഉണ്ടാക്കുകയും ചെയ്തതും അവന്റെ ദൃഷ്ടാന്തങ്ങളില്&zwj; പെട്ടതത്രെ. തീര്&zwj;ച്ചയായും അതില്&zwj; ചിന്തിക്കുന്ന ജനങ്ങള്&zwj;ക്ക് ദൃഷ്ടാന്തങ്ങളുണ്ട് <br><span class="verse-number"> (വിശുദ്ധ ഖുര്&zwj;ആന്&zwj; 30:21)</span></p>
                    ...
                    <div class="form-reg position-relative">
                        ...
                        <!--style="border-right: 2px solid #ff5b85;padding-right: 15px;"-->
                            ...
                            <div class="w-100 register-heading-desk">
                                ...
                                <h2 class="pOne" style="color: #000;font-size:25px;">Register Now </h2>

                                <span class="hOne" style="color: #ff5b85;font-size:40px;font-weight: 600;margin-bottom: 0px;">its free!</span><br/>
...
<br/><br/>
                        <div class="regHeadBox borderRight d-flex align-items-center" style="border-right: 0px solid transparent;padding-right: 15px;margin-top: -68px;margin-left: 192px;">


<h3 class="hTwo" align="center" style="margin-bottom: 2px;font-size: 16px;font-weight: 750;display:none;color: #5aba47;/* font-family: 'APPLE_CARDS_ABBAS'; */font-family: ;width: 85%;" noto="" sans="" malayalam",="" sans-serif;="" "="">
    സന്തോഷകരമായ ജീവിതത്തിനു അനുയോജ്യമായ പങ്കാളിയെ കണ്ടെത്തൂ......</h3>
    ...
    <img style="margin-left: 74px;margin-top: -23px;" src="<?php echo base_url();?>assets/images/male.svg"  id="ml" alt="male" width="24px" height="24px">
    ...
    <div class="vl" style="border-left: 2px solid #ff5b85;height: 35px;margin-left: 127px;margin-top: -28px;"></div>
    ...
    <img style="margin-left: 240px;margin-top: -27px;" src="<?php echo base_url();?>assets/images/female.svg" id="fl" alt="male" width="24px" height="24px">
    
    <!--<span style="border-left: 2px solid #ff5b85;height: 24px;margin-left:10px;padding-top: 35px;padding-bottom:12px;"></span>-->
    
    <div class="v2" style="border-left: 2px solid #ff5b85;height: 36px;margin-left: 292px;margin-top: -36px;">
    ...
    <p id="email_val" class="validationclass"></p>
            ...
            class="btn cstmBtnColrs registernow" style="background-color: #ff5b85;color:#fff;margin-left: -155px;margin-top: -9px;">
                Register Now</button>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-10 mx-auto text-center">
                ...
                <h2 class="subHead">Get ready <span style="color:#ff5b85;">with us</span></h2>
...
<section id="homeDownload" style="background:transparent linear-gradient( 6deg , #ff5b85b0 0%, #ff5b8573 100%) 0% 0% no-repeat padding-box;margin-bottom:15px;">
        ...
        <div class="row">
           ...
           <div class="col-md-8">  
                    ...
                    <!--<div class="search">-->
                        ...
                        <p class="pOne" style="font-size: 22px;font-weight: 550;">If you need help for registration,</p>

                        <p class="pTwo">Please Contact:  <a href="tel:+918593999888" style="color:#1a75e8;text-decoration:none;font-weight: 500;">+91-8593999888 </a></p>

                         <a href="tel:+918593999888" class="btn btn-primary mr-2" style="border-radius: 12px;width: 150px;text-decoration:none;" id="call">
                         <i class="fas fa-phone-alt"></i> Call
                         </a>

        <!-- WhatsApp Button -->
        <a href="https://wa.me/+918593999888" class="btn btn-success"  id="whatsapp"   style="border-radius: 12px;width: 150px;text-decoration:none;background-color: #0da738;border-color: #0da738;">
          ...
          <a href="https://apps.apple.com/in/app/happy-nikah/id1638696026">
                ...
                <!--style="width: 90%;position: absolute;left: -137px;top: -284px;z-index: 1;" id="play">-->
                <!--     </div>-->
                <!--      <div class="col-12 col-lg-4 col-md-12 col-xl-6 text-center position-relative">-->
            ...
            <div class="modal-body p-0">
                <div class="row">
                    <div class="col-12 col-lg-6 d-none d-lg-flex align-items-stretch">
                        <div class="leftBox w-100" style="background: url('https://happynikah.com/assets/images/logingLeftBg.png')">
                            <h2 class="modalHead mb-4" id="loginModalLabel">Search Profiles<br><span>Anytime! Anywhere!!</span></h2>
                            <p class="lpone">Finding your perfect match has never been easier with the Goto nikah application</p>
    ...
    background-position: center center;">
                        <div class="rbox w-100">
                            ...
                            <div class="d-flex justify-content-between mb-5">
                                <h3 class="welcomeHead">Welcome Back!<br><span style="color:#ff5b85;">Please Login</span></h3>
                                <!--<img src="<?php echo base_url() ?>happyadmin/assets/images/goto nikah logo.png" alt="go to Nikah" style="width:100px !important;" -->
                                <!-- class="llogo" width="auto" height="auto">-->
                            ...
                            <div class="emailLogBox">
                                <form class="customForm">
                                    ...
                                    <p class="note">By continuing, you agree to Goto nikah's <a href="<?php echo site_url('user/terms'); ?>">Terms of Use</a> and 
                                    <a href="<?php echo site_url('user/privacy'); ?>">Privacy Policy</a></p>
                                    <button type="button" class="btn cstmBtnColr w-100" id="loginbtn" onclick="login()" style="background-color:#ff5b85;">Login</button>
                                    <p class="orTxt">OR</p>
                                    <button type="button" class="btn w-100 mb-3 loginOtpBtn" style="color: #ff5b85;border: 1px solid #ff5b85;">OTP Login</button>
                                </form>
                            </div>
                            <div class="otpLogBox" style="display:none;">
                                ...
                                <p class="note">By continuing, you agree to Happy nikah's <a href="<?php echo site_url('user/terms'); ?>">Terms of Use</a>
                                and <a href="<?php echo site_url('user/privacy'); ?>">Privacy Policy</a></p>
                                <button type="button" class="btn cstmBtnColr sendOtp w-100" onclick="otplogin()" style="background-color: #ff5b85;">Send OTP</button>
                                <p class="orTxt">OR</p>
                                <button type="button" class="btn w-100 mb-3 loginEmailBtn" style="color: #ff5b85;border: 1px solid #ff5b85;"> Login with Id & Password</button>
                                </div>
                                </form>
                           ...
                           <!-- <div class="d-flex justify-content-between mb-3">
                            ...
                            <p class="text-center newtoTxt">New to GotoNikah <a href="<?php echo site_url('landing'); ?>">Register Now</a></p>
                        </div>
                    ...
                    <div class="col-12 col-lg-6 d-flex align-items-stretch">
                        ...
                        <div class="rbox w-100">
                            ...
                            <div class="otpverifyBox">
                                ...
                                <button type="button" class="btn cstmBtnColr w-100"  style="background-color: #5ABA47;" onclick="verify_mobile()">SUBMIT</button>
...
<a href="javascript:" id="return-to-top" style="background:#rgb(255 91 133);"><i class="icon-chevron-up"></i></a>



<?php 
// include('include/footer_gotonikah.php'); 

?>

<div class="row">
            <div class="col-12 text-center">
                <p class="at">© 2023 <a href="<?php echo  base_url();?>" style="color:#000;text-decoration:none;">Happynikah</a> All Rights Reserved</p>
            </div>
        </div>
            ...
            success: function(response) {
                ...
                if (response == 1) {
                    ...
                    setTimeout(function() {
                        ...
                        window.location.href = "<?php echo base_url(); ?>user/congratulations";
...
// });
    ...
    function myFunctionread() {
        ...
        *, *::before, *::after {
        ...
        .loginOtpBtn:hover, .loginEmailBtn:hover
        {
        color:#5ABA47; 
        }
        .loginOtpBtn, .loginEmailBtn
        {
        color: #5ABA47;
        ...
        #otpModal .cstmBtnColr
        {
             color: #5aba47;  
        }
        #otpModal .leftBox
        {
            background:transparent linear-gradient( 209deg , #6fe872d1 0%, #a1df94db 100%) 0% 0% no-repeat padding-box;
        }
