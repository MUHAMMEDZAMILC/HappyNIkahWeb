...
<style type="text/css">
  ...
  .proPhotoUpload .proUpldedImg {
                ...
                <div class="col-12">
                    <div id="ERtabV" class="resp-vtabs hor_1">
                        ...
                        <li class="resp-tab-item hor_1" onclick="window.location.href='<?php echo site_url('user/registration_step1_gotonikah?currentpage=1'); ?>'">
                            ...
                            <li class="resp-tab-item hor_1" onclick="window.location.href='<?php echo site_url('user/registration_stepthree_gotonikah?currentpage=1'); ?>'">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div class="circleNo">
                                            <span>3</span>
                            ...
                            <li class="resp-tab-item hor_1 resp-tab-active" onclick="window.location.href='<?php echo site_url('user/registration_stepfour_gotonikah?currentpage=1'); ?>'">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div class="circleNo">
                                            <span>4</span>
                        ...
                        <div class="resp-tabs-container hor_1">
                            ...
                            <div class="resp-tab-content hor_1 resp-tab-content-active">
                                <div class="row">
                                    ...
                                    <form action="<?php echo site_url('user/register_profiledescription_gotonikah'); ?>?currentpage=1" method="post" autocomplete="off" class="customForm" enctype="multipart/form-data" id="profile">
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-md-6 mb-3 mb-md-0">
                                                    <button type="button" class="btn backBtn w-100" onclick="window.location.href='<?php echo site_url('user/registration_stepthree_gotonikah?gotoback=3'); ?>'">Back</button>
                                                </div>
    ...
    #registerPage .custom_radio input[type="radio"]:checked + label 
    {
    border: 1px solid #5aba47;
    color: #5aba47;
}
...
.custom_radio input[type="radio"]:checked + label:before 
{
    ...
    box-shadow: inset 0 0 0 4px white, inset 0 0 0 10px #5aba47;
}
