...
<style type="text/css">
  ...
  .proPhotoUpload .listTypeHead span
  {
        ...
        <div class="container">
            ...
            <i class="fa fa-eye" id="togglePassword" class="togglePassword"></i>
                        ...
                        <div class="col-lg-12 text-center settings-form">
                            <button type="button" class="submit-settings" name="submit-settings" id="submit-settings" 
                            onclick="submit_setting('<?= $this->session->userdata('user_id')?>')">Save</button>
                        </div>
                    </div>
                    <?php include('include/side_menu_gotonikah.php'); ?>
                    <!-- mobile app advrtisment -->
                    <div class="appAdvBox2">
                        <h2 class="subHead mb-4">Search Profiles<br><span style="color:#5ABA47;">Anytime! Anywhere!!</span></h2>
