...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
   ...
   #banner .regBox
    ...
    .col-12.col-lg-7.col-md-12.d-flex.align-items-center
    {
    padding-right: 0px;
    margin-top: -20px;
    ...
    position: relative;
    z-index: 1;
    box-shadow: 0px 10px 30px #504d4d;
...
<body>
    <section id="header">
        ...
        <!--<div class="col-12 col-lg-5 col-md-12 d" style="padding-right: 0px; display: flex; align-items: center; justify-content: center;">-->
        <!--<div class="regBox" style="height: 550px; background-color: #FF2662; text-align: center;" id="reg">-->
        <!--<img src="assets/images/logonew.png" style="max-width: 100%; max-height: 100%;" alt="App Store">-->
        <!--</div>-->
        <!--</div>-->


        <div class="col-12 col-lg-5 col-md-12 d" style="padding-right:0px;text-align:center;">
   
        <div class="regBox" style="height: 550px; background-color:#FF2662;" id="reg">
         <!--<img src="assets/images/Asset 1@4x.png" style="width: 50%;max-width: 100%;max-height: 100%;margin: 90px auto;" alt="Happy nikah logo" id="logo">-->
        <!--<img src="assets/images/Asset 1@4x.png" style="width: 50%;max-width: 100%;max-height: 100%;margin: 30px auto;" alt="Happy nikah logo" id="logo"> -->
 
 
  <img src="assets/images/WhatsApp Image 2024-02-05 at 10.53.17 AM.jpeg" style="max-width: 100%;max-height: 100%;" alt="Happy nikah logo" id="logo"> 
       <!--<label style="color:#fff;line-height:unset;font-size: 35px;font-weight:500;" id="new">-->
       <!--  <span style="display: block;" id="choose">Choose </span>-->
       <!--  <span style="display: block;" id="our_app"> Our App </span>-->
       <!--<span style="display: block;">for Better </span> -->
       ...
       <!--</label>      -->
        ...
        <div class="col-12 col-lg-7 col-md-12 d-flex align-items-center" style="padding-left:3px;">
        <div class="regBox" style="height:550px;" id="appsection">
        ...
        {?>
         ...
         <?php  $originalpass = $result->originalpass;?>
         
        <div id="userSection" class="usersection">
        <label style="color:#fff; font-size:20px;">Name:&nbsp;&nbsp;<?= $userdetails->name?></label>
        <label style="color:#fff; font-size:20px;">HNID:&nbsp;&nbsp;<?= $userdetails->happynikah_id?></label>
        <label style="color:#fff; font-size:20px;">Password:&nbsp;&nbsp;<?php echo $originalpass;?></label>
        </div>
        <?php }?>
        ...
        <form action="https://www.waytonikah.com/UserAuthentication/registertype" method="post" class="col-12" onsubmit="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; return ValidationBasic();">
        <div class="row" style="margin-top: 60px;" id="app_row">
        <div class="col-md-6">
        <!--<button type="button" class="btn btn-primary" id="apps" style="width: 100%;background-color: #fff;border-color: unset;border-radius: 10px;height: 260px;">-->
        
        <div class="text-center mb-4">
        <a href="https://apps.apple.com/in/app/happy-nikah/id1638696026">   
        
        <!--<img src="assets/images/new_appstore.png" style="width:80%" alt="App Store" id="appstore">-->
        
        <img src="assets/images/apple.png" style="width:80%" alt="App Store" id="appstore">
        
        </a> 
        
        </div>
        <!--<label style="color: #FF5B85;text-align: center;font-size: 18px;font-weight: 500;margin-bottom: 40px;margin-top: 40px;">-->
        <!--<a href="https://play.google.com/store/apps/details?id=com.sysol.happy_nikah" style="text-decoration:none;color: #FF5B85;">-->
        ...
        <div class="col-md-6">
            <div class="text-center mb-4">
        <!--<button type="button" class="btn btn-primary" style="width: 100%;background-color: #fff;border-color: unset;border-radius: 10px;height: 260px;">-->
        <a href="https://play.google.com/store/apps/details?id=com.sysol.happy_nikah"> 
        <!--<img src="assets/images/new_playstore.png" style="width:80%" alt="Play Store" id="playstore">-->
       
       <img src="assets/images/android.png" style="width:80%" alt="Play Store" id="playstore"> 
        </a> 
        
        <!--<label style="color: #FF5B85;text-align: center;font-size: 18px;font-weight: 500;margin-bottom: 40px;margin-top: 40px;"> -->
        <!--<a href="https://apps.apple.com/in/app/happy-nikah/id1638696026" style="text-decoration:none;color: #FF5B85;">-->
        <!-- Download the App from PLAY STORE</a></label>-->
        <!--</button>-->
        ...
        <div class="row">
        <div class="col-md-12">
        <button type="button" class="btn btn-primary" style="width: 100%; background-color: #fff; border-color: unset; border-radius: 10px; margin-top: 38px; 
        height: 60px; display: flex; align-items: center;">
        <img src="assets/images/world-wide-web.png" style="width: 7%; float: left; margin-left: 20px;" alt="Website">
        
        <label style="color: #FF5B85; text-align: center; font-size: 18px; font-weight: 500;">
        <a href="<?php echo base_url();?>registration_step1?currentpage=1" style="text-decoration:none;color: #FF5B85;">Continue to Website </a>
        </label>
        </button>
        </div>
        ...
        if (created_by != '' && name != '' && phone != '' && checked_gender != null && flexCheckDefault != undefined && countryCode != '0' && age != '' && country!='' &&
        state!='' && home_district!='') {
                // $('#submitbtn').click();
                $.ajax({
